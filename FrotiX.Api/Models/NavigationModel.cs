...
namespace FrotiXApi.Models
{
            ...
            foreach (var item in items)
            {
                try
                {
                    ...
                    var objControleAcesso = _currentUnitOfWork.ControleAcesso.GetFirstOrDefault(
                        ca => ca.UsuarioId == userId && ca.RecursoId == ObjRecurso.RecursoId
                    );
                    ...
                    if (objControleAcesso.Acesso)
                    {
                        ...
                        // Por esta linha para resolver CA1860 e CS8602:
                        if (
    ...
    // Adicione este método de extensão para string para resolver CS1061
    public static class StringExtensions
    {
        public static bool IsVoid(this string href)
        {
            return string.Equals(href, NavigationModel.Void, StringComparison.OrdinalIgnoreCase);
        }
    }
}
