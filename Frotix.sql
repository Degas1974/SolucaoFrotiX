...
-- Script date 06/02/2026 09:05:31
...
--
-- Create foreign key [FK_MotoristaItensPendentes_Motorista] on table [dbo].[MotoristaItensPendentes]
--
PRINT (N'Create foreign key [FK_MotoristaItensPendentes_Motorista] on table [dbo].[MotoristaItensPendentes]')
GO
ALTER TABLE dbo.MotoristaItensPendentes WITH NOCHECK
  ADD CONSTRAINT FK_MotoristaItensPendentes_Motorista FOREIGN KEY (MotoristaId) REFERENCES dbo.Motorista (MotoristaId)
GO
...
--
-- Create foreign key [FK_MotoristaItensPendentes_Viagem] on table [dbo].[MotoristaItensPendentes]
--
PRINT (N'Create foreign key [FK_MotoristaItensPendentes_Viagem] on table [dbo].[MotoristaItensPendentes]')
GO
ALTER TABLE dbo.MotoristaItensPendentes WITH NOCHECK
  ADD CONSTRAINT FK_MotoristaItensPendentes_Viagem FOREIGN KEY (ViagemId) REFERENCES dbo.Viagem (ViagemId)
GO
