...
// ║ LOCALIZAÇÃO: Pages/Temp/                                                     ║
// ║ FINALIDADE : PageModel temporário para desenvolvimento/testes.               ║
// ╠══════════════════════════════════════════════════════════════════════════════╣
// ║ DESCRIÇÃO: Página temporária para experimentos e testes durante dev.         ║
// ╠══════════════════════════════════════════════════════════════════════════════╣
// ║ LOTE: 23 — Pages/Temp | DATA: 29/01/2026                                     ║
// ╚══════════════════════════════════════════════════════════════════════════════╝
...
{
    Alerta.TratamentoErroComLinha("Index.cshtml.cs", "PreencheGridVeiculos", error);
    return; // padronizado
}
}
