 ...
 * ║  ╚═╝     ╚═╝  ╚═╝ ╚═════╝    ╚═╝   ╚═╝╚═╝  ╚═╝    ╚══════╝╚═╝   ╚═╝   ╚══════╝                        ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ UpsertCEscala.cshtml.cs                                                                               ║
 * ║ PageModel para criação de escalas - formulário de cadastro de novas escalas de serviço               ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 * ║ @arquivo    UpsertCEscala.cshtml.cs                                                                   ║
 * ║ @local      Pages/Escalas/                                                                            ║
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia Criação de escalas com seleção de motorista, veículo, turno e tipo de serviço            ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
using System;
