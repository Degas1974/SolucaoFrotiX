 ...
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ Upsert.cshtml.cs                                                                                      ║
 * ║ PageModel para criação e edição de Manutenções - formulário de cadastro/atualização                  ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 ...
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia Cadastro e edição de manutenções com seleção de veículo e motorista                      ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
