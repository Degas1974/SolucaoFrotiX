 ...
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ Upsert.cshtml.cs                                                                                      ║
 * ║ PageModel para criação e edição de Modelos de Veículo - formulário de cadastro/atualização           ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 * ║ @arquivo    Upsert.cshtml.cs                                                                          ║
 * ║ @local      Pages/ModeloVeiculo/                                                                      ║
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia Cadastro e edição de modelos de veículos vinculados a marcas                             ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
using FrotiX.Models;
