 ...
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ Upsert.cshtml.cs                                                                                      ║
 * ║ PageModel para criação e edição de Marcas de Veículo - formulário de cadastro/atualização            ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 * ║ @arquivo    Upsert.cshtml.cs                                                                          ║
 * ║ @local      Pages/MarcaVeiculo/                                                                       ║
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia Cadastro e edição de marcas de veículos (Toyota, Volkswagen, etc)                        ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
