 ...
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ Upsert.cshtml.cs                                                                                      ║
 * ║ PageModel para criação e edição de Lavadores - formulário de cadastro/atualização                    ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 ...
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia Cadastro e edição de lavadores com upload de foto e dados pessoais                       ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
...
namespace FrotiX.Pages.Lavador
{
    public class UpsertModel :PageModel
    {
        ...
        [BindProperty]
        public LavadorViewModel LavadorObj
        {
            get; set;
        }
        ...
        public IActionResult OnPostEdit(Guid id)
        {
            try
            {
                ...
                // =============================================
                var existeLavadorContrato = _unitOfWork.LavadorContrato.GetFirstOrDefault(u =>
                    (u.LavadorId == LavadorObj.Lavador.LavadorId) && (u.ContratoId == LavadorObj.Lavador.ContratoId)
                );
