...
// ╠══════════════════════════════════════════════════════════════════════════════╣
// ║ ARQUIVO    : UpsertRecurso.cshtml.cs                                         ║
// ║ LOCALIZAÇÃO: Pages/Usuarios/                                                 ║
// ║ FINALIDADE : PageModel para criação/edição de recursos de navegação.         ║
// ╠══════════════════════════════════════════════════════════════════════════════╣
// ║ DESCRIÇÃO: CRUD de recursos (itens de menu) com associação de permissões.     ║
// ╠══════════════════════════════════════════════════════════════════════════════╣
