# Documentação: MovimentacaoPatrimonio - Upsert
...
- **JS** (2):
  ...
  - `~/js/cadastros/movimentacaopatrimonio.js`
...
- ✅ Adicionado bloco de cabeçalho JSDoc com descrição geral do módulo
- ✅ Documentadas 2 funções: carregarDadosMovimentacao, salvarMovimentacao
...
- Pages/MovimentacaoPatrimonio/Upsert.cshtml - Substituição de `btn-ftx-fechar` por `btn-vinho` em botão de modal
