# Documentação: Multa - UpsertTipoMulta
...
**Arquivos Afetados**:
- Pages/Multa/UpsertTipoMulta.cshtml - Substituição de `btn-ftx-fechar` por `btn-vinho` em botão de modal
