# Documentação: Multa - UpsertOrgaoAutuante
...
## [22/01/2026] - Documentação JSDoc Completa no orgaoautuante.js

**Descrição**: Adicionada documentação JSDoc padrão FrotiX completa ao arquivo JavaScript de cadastro de órgãos autuantes.
...
- ✅ Documentação do event handler btn-delete com Alerta.Confirmar
- ✅ Documentação do fluxo AJAX de exclusão com tratamento de erros
...
- Pages/Multa/UpsertOrgaoAutuante.cshtml - Substituição de `btn-ftx-fechar` por `btn-vinho` em botão de modal
