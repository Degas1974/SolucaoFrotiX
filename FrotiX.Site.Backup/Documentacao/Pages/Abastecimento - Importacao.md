...
<button
  type="button"
  id="btnImportar"
  class="btn btn-fundo-laranja btn-lg w-100"
  disabled
>
...
- ✅ Adicionado bloco de cabeçalho JSDoc com descrição geral, dependências (SignalR, jQuery, Bootstrap 5, FontAwesome, SheetJS) e metadados
- ✅ Documentação inline em todas as funções JavaScript do arquivo
