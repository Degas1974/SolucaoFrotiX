...
```html
<iframe
  title="Frotix Atualizado - Relatório por Veículo"
  width="100%"
  height="900"
...
**Descrição**: Adição de documentação JSDoc nos scripts JavaScript embarcados.
...
- ✅ Documentadas 10 funções: stopEnterSubmitting, toolbarClick, PreencheListaRequisitantes, PreencheListaSetores, RequisitanteValueChange, MotoristaValueChange, VeiculoValueChange, valueChange, select, ddtCombustivelChange
