...
- ✅ **Mudar Senha**: Ação rápida na coluna de ações para ir à tela de alteração
...
5. **Ações**: Botões de Editar, Recursos, Foto, Mudar Senha, Excluir
...
<table id="tblUsuario" class="table">
  <thead>
    <!-- Cabeçalho gerado pela DataTable -->
  </thead>
</table>
...
## [21/01/2026 14:20] - UI: novo botão Mudar Senha e padronização Duotone

**Descrição**: Inclusão de botão "Mudar Senha" na coluna de ações, ajuste de largura da coluna e padronização de ícones para FontAwesome Duotone.
...
- ✅ Ações agora incluem botão de Mudar Senha
- ✅ Largura da coluna de ações ajustada para 20%
- ✅ Ícones `fa-solid` substituídos por `fa-duotone`
...
| 2.4    | 21/01/2026      | Botão Mudar Senha + ícones Duotone na grid                          |
