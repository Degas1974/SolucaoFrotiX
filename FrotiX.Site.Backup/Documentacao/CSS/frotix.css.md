...
O header principal precisava exibir o usuário logado com o padrão visual FrotiX, incluindo ícone duotone padrão.

### Solução

Criar estilos dedicados para o rótulo do usuário no header, com cores e truncamento seguros.
...
- Ícone duotone usa paleta padrão FrotiX (laranja/cinza)
...
## [21/01/2026] - Header do App: usuário logado + ícone duotone padrão

**Descrição**: Adicionados estilos para exibição do usuário logado no header principal com ícone FontAwesome Duotone e truncamento seguro.
...
- ✅ Ícone duotone com paleta laranja/cinza padrão FrotiX
- ✅ Melhor leitura no topo do sistema
