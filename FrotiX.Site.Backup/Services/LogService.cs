...
/// │ CLASSE: LogService
/// │──────────────────────────────────────────────────────────────────────────────
/// │ DESCRIÇÃO: Implementação do serviço de logging centralizado para FrotiWeb.
/// │            Grava logs em arquivos diários na pasta Logs.
/// │──────────────────────────────────────────────────────────────────────────────
/// │ REQUISITOS:
/// │    - Acesso ao File System (ContentRootPath).
/// │    - HttpContextAccessor para capturar Usuário e URL.
/// │──────────────────────────────────────────────────────────────────────────────
/// </summary>
public class LogService : ILogService
{
    ...
    /// │ DESCRIÇÃO: Inicializa o diretório de logs e o serviço.
    /// │──────────────────────────────────────────────────────────────────────────────
    /// </summary>
