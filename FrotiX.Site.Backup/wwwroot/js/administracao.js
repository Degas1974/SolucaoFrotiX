 ...
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║ ❓ POR QUE EXISTO?                                                       ║
 * ║    Dashboard de Administração com gráficos Chart.js para análise de:     ║
 * ║    • Normalização de dados (pizza e por tipo)                            ║
 * ║    • Tipo de uso de veículos                                             ║
 * ║    • Top 10 veículos e motoristas                                        ║
 * ║    • Custos por finalidade                                               ║
 * ║    • Veículos próprios vs terceirizados                                  ║
