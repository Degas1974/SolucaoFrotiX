 ...
 * │                                                                          │
 * │ 18. truncarTexto(texto, maxLength = 100)                               │
 * │     → Retorna texto.substring(0, maxLength) + "..."                    │
 * │                                                                          │
 * │ 19. limparDropdown()                                                    │
 * │     → Limpa #listaAlertasNavbar innerHTML = ''                         │
 * │                                                                          │
 * │ 20. contarAlertasNaoLidos()                                            │
 * │     → return alertasNaoLidos.length                                    │
 * │                                                                          │
 * │ 21. removerAlertaDoArray(alertaId)                                     │
 * │     → alertasNaoLidos = alertasNaoLidos.filter(a => a.id !== alertaId)│
 * │                                                                          │
 * │ 22. adicionarAlertaAoArray(alerta)                                     │
 * │     → alertasNaoLidos.unshift(alerta) - adiciona no início           │
 * │                                                                          │
 * │ 23. TratamentoErroComLinha(funcao, erro)                               │
 * │     → Se TratamentoErroComLinha global existe: chama                  │
 * │     → Senão: console.error com stack trace                             │
 * └──────────────────────────────────────────────────────────────────────────┘
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 * ⚠️ CRÍTICO: Navbar global - testar SignalR reconexão!
 * ****************************************************************************************/
/*
