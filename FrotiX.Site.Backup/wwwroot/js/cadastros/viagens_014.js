/**
 * ═══════════════════════════════════════════════════════════════════════════
 * VIAGENS (VERSÃO ALTERNATIVA) - MÓDULO DE GERENCIAMENTO
 * ═══════════════════════════════════════════════════════════════════════════
 * @description Versão alternativa do módulo de viagens com funcionalidades
 *              similares ao viagens_001.js. Inclui:
 *              - Listagem de viagens em DataTable
 *              - Modal de finalização de viagem
 *              - Validação de datas, horas e quilometragem
 *              - Cancelamento de viagens
 *              - Upload de imagens de ocorrência
 * @file viagens_014.js
 * @requires jQuery, DataTables, Bootstrap 5, Syncfusion EJ2, SweetAlert, Toastr
 * @see /Views/Viagem/Index.cshtml
 * @note Este arquivo usa SweetAlert (swal) ao invés de Alerta.Confirmar
 * ═══════════════════════════════════════════════════════════════════════════
 */
 ...
 * ═══════════════════════════════════════════════════════════════════════════
 * @description Configura componentes e carrega lista de viagens
 */
 ...
 * ═══════════════════════════════════════════════════════════════════════════
 * @description Handler para cancelar viagem usando SweetAlert para confirmação
...
$(document).on('click', '.btn-cancelar', function () {
    try {
        ...
        // Exibe diálogo de confirmação usando SweetAlert
        swal({
