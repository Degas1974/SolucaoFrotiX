 ...
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║ ❓ POR QUE EXISTO?                                                       ║
 * ║    Gestão de Patrimônio - Bens Patrimoniais da Frota.                    ║
 * ║    • CRUD completo de itens patrimoniais                                 ║
 * ║    • Movimentações (transferências, baixas)                              ║
 * ║    • Histórico de localização e responsáveis                             ║
 * ║    • Integração com seções e setores                                     ║
 * ║                                                                          ║
 * ║ 🔗 RELEVÂNCIA: Alta (Administração - Patrimônio)                          ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 */
