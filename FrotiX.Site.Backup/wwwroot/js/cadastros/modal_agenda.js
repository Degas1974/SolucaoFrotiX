 ...
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║ ❓ POR QUE EXISTO?                                                       ║
 * ║    Modal de Agendamento de Viagens (Calendário).                         ║
...
function onPeriodoChange(e) {
    // CRÍTICO: Não limpar se estamos carregando uma viagem existente
...
function onViagemClick(event) {
    ...
    // Mostrar campos de viagem (divNoFichaVistoria removido - agora usa botão ao lado do Destino)
