...
*  #   MODULO:  VALIDAÇÕES - REGRAS DE NEGÓCIO CENTRALIZADAS                                       #
...
{
    /// ╔══════════════════════════════════════════════════════════════════════════════╗
    /// ║ 📌 NOME: Validations (Namespace)                                             ║
    /// ╠══════════════════════════════════════════════════════════════════════════════╣
    /// ║ 📝 DESCRIÇÃO:                                                                ║
    /// ║    Biblioteca completa de validações server-side e client-side. Inclui      ║
    /// ║    validações de documentos (CPF, CNPJ, CNH), entidades de negócio e        ║
    /// ║    regras específicas do domínio de frotas.                                  ║
    /// ║                                                                              ║
    /// ║ 🎯 IMPORTÂNCIA PARA A SOLUÇÃO:                                              ║
    /// ║    REGRAS DE NEGÓCIO CRÍTICAS. Garante integridade dos dados e conformidade ║
    /// ║    com requisitos legais/regulatórios. Previne entrada de dados inválidos.  ║
    /// ╠══════════════════════════════════════════════════════════════════════════════╣
    /// ║ 📚 CATEGORIAS DE VALIDAÇÃO:                                                  ║
    /// ║    • Documentos: CPF, CNPJ, CNH, Placa, CRLV                                 ║
    /// ║    • Entidades: Motorista, Veículo, Viagem, Abastecimento                    ║
    /// ║    • Negócio: Períodos, conflitos, limites, autorizações                     ║
    /// ║    • Segurança: Senhas fortes, tokens, permissões                            ║
    /// ╠══════════════════════════════════════════════════════════════════════════════╣
    /// ║ 🔗 ESCOPO: GLOBAL - Usado em Models (DataAnnotations) e Controllers          ║
    /// ║    • Arquivos relacionados: Models/*.cs, Controllers/*.cs                   ║
    /// ╚══════════════════════════════════════════════════════════════════════════════╝
    namespace Validations
    {
        // ═══════════════════════════════════════════════════════════════════════
        // SERVER SIDE VALIDATIONS - Data Annotations & Custom Validators
        // ═══════════════════════════════════════════════════════════════════════
