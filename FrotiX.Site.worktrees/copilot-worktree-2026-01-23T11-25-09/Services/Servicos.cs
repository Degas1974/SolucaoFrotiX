...
*  #   MODULO:  SERVIÇOS - BIBLIOTECA DE UTILITÁRIOS (SÍNCRONO)                                    #
...
namespace FrotiX.Services
{
    ...
    /// ╠══════════════════════════════════════════════════════════════════════════════╣
    /// ║ 📝 DESCRIÇÃO:                                                                ║
    /// ║    Biblioteca de funções utilitárias síncronas. Inclui cálculos, validações,║
    /// ║    formatações e conversões usadas em toda a aplicação.                      ║
    /// ║                                                                              ║
    /// ║ 🎯 IMPORTÂNCIA PARA A SOLUÇÃO:                                              ║
    /// ║    BIBLIOTECA CENTRAL. Centraliza lógica reutilizável evitando duplicação   ║
    /// ║    de código. Complementa ServicosAsync com versões síncronas.              ║
    /// ╠══════════════════════════════════════════════════════════════════════════════╣
    /// ║ 📚 CATEGORIAS:                                                               ║
    /// ║    • Cálculos: Custos de viagem, consumo, distâncias                         ║
    /// ║    • Formatações: Moeda, data, documentos (CPF/CNPJ/Placa)                   ║
    /// ║    • Validações: Email, telefone, CEP                                        ║
    /// ║    • Conversões: String→Decimal, Base64→Image, etc                           ║
    /// ║    • Utilitários: Geração de códigos, criptografia, comparações              ║
    /// ╠══════════════════════════════════════════════════════════════════════════════╣
    /// ║ 🔗 ESCOPO: GLOBAL - Usado por Controllers, Services e Views                  ║
    /// ║    • Arquivos relacionados: ServicosAsync.cs, Validations.cs                ║
    /// ╚══════════════════════════════════════════════════════════════════════════════╝
