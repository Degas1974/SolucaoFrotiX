...
*  #   MODULO:  SERVIÇOS - FUNÇÕES ASSÍNCRONAS DE CÁLCULO                                          #
...
namespace FrotiX.Services
{
    ...
    /// ╠══════════════════════════════════════════════════════════════════════════════╣
    /// ║ 📝 DESCRIÇÃO:                                                                ║
    /// ║    Biblioteca estática de funções assíncronas para cálculos de custos de    ║
    /// ║    viagens. Calcula combustível, pedágios, manutenção e custos totais.      ║
    /// ║                                                                              ║
    /// ║ 🎯 IMPORTÂNCIA PARA A SOLUÇÃO:                                              ║
    /// ║    REGRA DE NEGÓCIO CRÍTICA. Centraliza todos os cálculos financeiros de    ║
    /// ║    viagens, garantindo consistência nos valores exibidos em todo sistema.   ║
    /// ╠══════════════════════════════════════════════════════════════════════════════╣
    /// ║ 📞 FUNÇÕES PRINCIPAIS:                                                       ║
    /// ║    • CalculaCustoCombustivelAsync() → Custo de combustível da viagem        ║
    /// ║    • CalculaCustoPedagioAsync() → Custo total de pedágios                    ║
    /// ║    • CalculaCustoManutencaoAsync() → Custo de manutenções preventivas        ║
    /// ║    • CalculaCustoTotalAsync() → Custo total consolidado da viagem            ║
    /// ╠══════════════════════════════════════════════════════════════════════════════╣
    /// ║ 🔗 ESCOPO: PÚBLICA - Usado por Controllers e Services                        ║
    /// ║    • Arquivos relacionados: ViagemController, DashboardViagensController    ║
    /// ╚══════════════════════════════════════════════════════════════════════════════╝
    public static class ServicosAsync
    {
        /// ╔══════════════════════════════════════════════════════════════════════════════╗
        /// ║ 📌 NOME: CalculaCustoCombustivelAsync                                        ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📝 DESCRIÇÃO:                                                                ║
        /// ║    Calcula custo de combustível baseado em KM rodados e consumo do veículo.  ║
        /// ║    Usa último abastecimento ou média histórica como referência de preço.     ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📥 PARÂMETROS:                                                               ║
        /// ║    • viagemObj: Objeto Viagem com KM inicial/final e veículo                 ║
        /// ║    • _unitOfWork: Unit of Work para acesso aos dados                         ║
        /// ║                                                                              ║
        /// ║ 📤 RETORNO:                                                                  ║
        /// ║    • Task<double>: Custo calculado de combustível                            ║
        /// ╚══════════════════════════════════════════════════════════════════════════════╝
