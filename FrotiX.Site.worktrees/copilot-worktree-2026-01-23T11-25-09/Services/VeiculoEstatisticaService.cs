...
namespace FrotiX.Services
{
    /* > ---------------------------------------------------------------------------------------
     ...
     > ---------------------------------------------------------------------------------------
     > 🆔 **Nome:** VeiculoEstatisticaService.cs
     > 📍 **Local:** Services
     > ❓ **Por que existo?** Serviço responsável por calcular estatísticas de viagens e consumo de veículos para calibração de alertas.
     > 🔗 **Relevância:** Crítica (Core de Inteligência)
     > --------------------------------------------------------------------------------------- */
    ...
    public class VeiculoEstatisticaService
    {
        ...
        /// ╔══════════════════════════════════════════════════════════════════════════════╗
        /// ║ 📌 NOME: ObterEstatisticasAsync                                              ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📝 DESCRIÇÃO:                                                                ║
        /// ║    Obtém estatísticas de um veículo, utilizando cache para performance.      ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📥 PARÂMETROS:                                                               ║
        /// ║    • veiculoId (Guid): Identificador do veículo                              ║
        /// ║                                                                              ║
        /// ║ 📤 RETORNO:                                                                  ║
        /// ║    • EstatisticaVeiculoDto: Objeto com métricas calculadas                   ║
        /// ╚══════════════════════════════════════════════════════════════════════════════╝
        public async Task<EstatisticaVeiculoDto> ObterEstatisticasAsync(Guid veiculoId)
        {
            try
            {
                // [PERFORMANCE] Definição de chave de cache única por veículo
        ...
        /// ╔══════════════════════════════════════════════════════════════════════════════╗
        /// ║ 📌 NOME: CalcularEstatisticasAsync                                           ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📝 DESCRIÇÃO:                                                                ║
        /// ║    Realiza o cálculo pesado das estatísticas baseadas no histórico.          ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📥 PARÂMETROS:                                                               ║
        /// ║    • veiculoId (Guid): Identificador do veículo                              ║
        /// ║                                                                              ║
        /// ║ 📤 RETORNO:                                                                  ║
        /// ║    • EstatisticaVeiculoDto: Dados estatísticos processados                   ║
        /// ╚══════════════════════════════════════════════════════════════════════════════╝
        private async Task<EstatisticaVeiculoDto> CalcularEstatisticasAsync(Guid veiculoId)
        {
            try
            {
                // [DADOS] Buscar informações do veículo (simplificado para evitar problemas com EF Core)
                ...
                // [LOGICA] Montar descrição a partir de Marca e Modelo (se disponíveis)
                string descricao = "";
                ...
                // [DADOS] Buscar últimas N viagens finalizadas com km válido
                ...
                // [REGRA] Filtrar viagens com duração válida (entre 1 minuto e 24 horas)
                viagens = viagens
                ...
                // [LOGICA] Calcular estatísticas de quilometragem
        ...
        /// ╔══════════════════════════════════════════════════════════════════════════════╗
        /// ║ 📌 NOME: CalcularDuracaoMinutos                                              ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📝 DESCRIÇÃO:                                                                ║
        /// ║    Calcula a diferença em minutos entre dois momentos (início e fim).        ║
        /// ╚══════════════════════════════════════════════════════════════════════════════╝
