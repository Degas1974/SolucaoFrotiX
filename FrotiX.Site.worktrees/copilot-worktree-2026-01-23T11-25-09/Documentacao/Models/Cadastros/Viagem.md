...
## [21/01/2026] - Novo Campo TemFichaVistoriaReal

**Descrição**: Adicionado novo campo `TemFichaVistoriaReal` ao model `Viagem.cs` para identificar viagens que possuem ficha de vistoria real cadastrada (não a ficha padrão/amarelinha).
...
**Arquivos Afetados**:
- `Models/Cadastros/Viagem.cs` (linha ~241)

**Script SQL**: `Scripts/AddTemFichaVistoriaReal.sql`

**Impacto**: Permite habilitar/desabilitar botão de visualização de ficha no modal
