# Lockout.cshtml.cs — PageModel de lockout

> **Arquivo:** `Areas/Identity/Pages/Account/Lockout.cshtml.cs`  
> **Papel:** autenticar usuário após bloqueio e redirecionar.

---

## ✅ Visão Geral

Desloga o usuário no `OnGetAsync` e aceita a senha para reautenticação.
...
- Usa `ViewData["Email"]` como username no login.
- Retorna para `LoginWith2fa` quando necessário.
