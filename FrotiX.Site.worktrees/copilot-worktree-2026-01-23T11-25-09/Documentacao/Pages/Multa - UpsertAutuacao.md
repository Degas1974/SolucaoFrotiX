# Documentação: Multa - UpsertAutuacao
...
- **JS** (3):
  ...
  - `~/js/cadastros/upsert_autuacao.js`
...
## [16/01/2026 17:00] - Refatoração Completa Multas e Telerik Editor

**Descrição**: Refatoração profunda da interface de multas e lógica de validação.

**Mudanças**:

- **Editor Telerik**: Substituído o editor Syncfusion por Kendo UI Editor no campo de Observações.
- **Title Case**: Adicionada formatação automática para Número da Infração e Localização.
- **Campos Obrigatórios**: Adicionado asterisco vermelho (`label-required`) em todos os campos mandatórios.
- **Validação de Datas**: Implementada cronologia rigorosa (`Data Infração < Data Notificação < Data Limite < Data Pagamento`) no JS.
- **Valor Obrigatório**: `ValorAteVencimento` agora é obrigatório (UI e Model).
...
- Pages/Multa/UpsertAutuacao.cshtml - Substituição de `btn-ftx-fechar` por `btn-vinho` em botão de modal
