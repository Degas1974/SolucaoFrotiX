...
## [18/01/2026 19:10] - Ajuste da legenda de finalização/baixa

**Descrição**:

- Atualizado texto da legenda para "Finalizado/Baixado por:" na área de informações finais da OS.
...
- Pages/Manutencao/Upsert.cshtml - Substituição de `btn-ftx-fechar` por `btn-vinho` em botão de modal
