# Documentação: SecaoPatrimonial - Upsert
...
- **JS** (3):
  ...
  - `~/js/cadastros/secao_patrimonial.js`
  - `~/js/dropify.min.js`
...
- Pages/SecaoPatrimonial/Upsert.cshtml - Substituição de `btn-ftx-fechar` por `btn-vinho` em botão de modal
