# Documentação: Manutencao - ListaManutencao
...
- **JS** (1):
  - `~/js/cadastros/ListaManutencao.js`
...
## [18/01/2026 10:45] - Exibição do número da OS no modal de baixa

**Descrição**:

- Número da OS movido para junto do título do modal, com prefixo "OS:" e espaçamento dedicado.
- Ajuste visual para manter o número discreto e legível.
