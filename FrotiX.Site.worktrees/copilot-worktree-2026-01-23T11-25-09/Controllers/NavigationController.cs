 ...
 * |                                                       |
 * |   FrotiX Core - Gestão de Navegação (Core Stack)      |
 * |_______________________________________________________|
 *
 * (IA) Controlador responsável pela gestão dinâmica do Menu de Navegação.
...
{
    /// ╔══════════════════════════════════════════════════════════════════════════════╗
    /// ║ 📌 NOME: NavigationController                                              ║
    /// ╠══════════════════════════════════════════════════════════════════════════════╣
    /// ║ 📝 DESCRIÇÃO:                                                                ║
    /// ║    Gestão dinâmica do Menu de Navegação.                                     ║
    /// ║    Manipula nav.json e sincroniza com a tabela Recurso.                      ║
    /// ╠══════════════════════════════════════════════════════════════════════════════╣
    /// ║ 🔗 ESCOPO: API REST                                                          ║
    /// ║    • Rota base: /api/Navigation                                             ║
    /// ╚══════════════════════════════════════════════════════════════════════════════╝
    ...
    public class NavigationController : Controller
    {
        ...
        /// ╔══════════════════════════════════════════════════════════════════════════════╗
        /// ║ 📌 NOME: NavigationController (Construtor)                                 ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📝 DESCRIÇÃO:                                                                ║
        /// ║    Inicializa o controlador com UnitOfWork, ambiente, cache e log.          ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📥 PARÂMETROS:                                                               ║
        ...
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📝 DESCRIÇÃO:                                                                ║
        /// ║    Retorna a estrutura hierárquica do nav.json para o frontend.             ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📤 RETORNO:                                                                  ║
        /// ║    • IActionResult: JSON com árvore de navegação.                            ║
        /// ╚══════════════════════════════════════════════════════════════════════════════╝
        [HttpGet]
        [Route("GetTree")]
        ...
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📝 DESCRIÇÃO:                                                                ║
        /// ║    Salva nova estrutura no nav.json e sincroniza Recurso no BD.             ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📥 PARÂMETROS:                                                               ║
        /// ║    • items (List<NavigationTreeItem>): Itens da árvore.                      ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📤 RETORNO:                                                                  ║
        ...
        public IActionResult SaveTree([FromBody] List<NavigationTreeItem> items)
        {
            try
            {
                ...
                // [MONTAGEM] Reconstrói a estrutura do nav.json.
                var navigation = new
                {
                    version = "0.9" ,
        ...
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📝 DESCRIÇÃO:                                                                ║
        /// ║    Adiciona novo item ao menu e cria o recurso correspondente.              ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📥 PARÂMETROS:                                                               ║
        /// ║    • item (NavigationItemDTO): Dados do item.                               ║
        /// ╠══════════════════════════════════════════════════════════════════════════════╣
        /// ║ 📤 RETORNO:                                                                  ║
        /// ║    • IActionResult: JSON com status e ID do recurso.                         ║
        /// ╚══════════════════════════════════════════════════════════════════════════════╝
        [HttpPost]
        [Route("AddItem")]
        public IActionResult AddItem([FromBody] NavigationItemDTO item)
        {
            try
            {
                // [VALIDACAO] Verifica se já existe recurso com esse NomeMenu.
                ...
                // [DADOS] Cria novo Recurso no BD (valores padrão).
                ...
                // [ACAO] Salva o Recurso para garantir existência no BD.
                _unitOfWork.Save();

                // [ACAO] Cria ControleAcesso para todos usuários.
        ...
        /// │ DESCRIÇÃO: Remove item e seus registros relacionados no BD.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        [HttpPost]
        [Route("DeleteItem")]
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Obter Árvore do Banco (GetTreeFromDb)
        /// │ DESCRIÇÃO: Retorna árvore de navegação do banco filtrada por usuário logado.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        [HttpGet]
        [Route("GetTreeFromDb")]
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Obter Árvore Admin (GetTreeAdmin)
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Debug da Árvore (DebugTreeAdmin)
        /// │ DESCRIÇÃO: DEBUG: Endpoint para diagnóstico de problemas na carga da árvore.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        [HttpGet]
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Salvar Árvore no Banco (SaveTreeToDb)
        /// │ DESCRIÇÃO: Salva alterações na árvore (reordenação, hierarquia) no banco de dados.
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Migrar de JSON (MigrateFromJson)
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Salvar Recurso (SaveRecurso)
        /// │ DESCRIÇÃO: Adiciona ou atualiza um recurso no banco (para a tela unificada).
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        [HttpPost]
        [Route("SaveRecurso")]
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Remover Recurso (DeleteRecurso)
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Obter Usuários com Acesso (GetUsuariosAcesso)
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Atualizar Acesso (UpdateAcesso)
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Habilitar Acesso para Todos (HabilitarAcessoTodosUsuarios)
        /// │ DESCRIÇÃO: Habilita acesso para todos os usuários do sistema ao criar novo item.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        [HttpPost]
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Montar Árvore Recursiva
        /// │ DESCRIÇÃO: Montar árvore recursiva a partir de lista de recursos.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Atualizar Recursos Recursivamente
        /// │ DESCRIÇÃO: Atualiza recursos recursivamente a partir da árvore.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Processar Itens para Migração
        /// │ DESCRIÇÃO: Processa itens do nav.json para migração.
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: TransformToTreeData
        /// │ DESCRIÇÃO: Transforma ListItem em NavigationTreeItem para a TreeView.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: TransformFromTreeData
        /// │ DESCRIÇÃO: Transforma NavigationTreeItem de volta para ListItem.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: EncodeHtmlEntities
        /// │ DESCRIÇÃO: Codifica caracteres especiais para HTML entities.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Sincronizar Recursos
        /// │ DESCRIÇÃO: Sincroniza itens da TreeView com a tabela Recurso.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: GetNextOrdem
        /// │ DESCRIÇÃO: Obtém a próxima ordem disponível para recursos.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Criar Controle de Acesso para Todos (CriarControleAcessoParaTodosUsuarios)
        /// │ DESCRIÇÃO: Cria ControleAcesso para todos os usuários ativos.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Obter Ícones FA Hierárquicos (GetIconesFontAwesomeHierarquico)
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: LoadFontAwesomeIconsFromJson
        /// │ DESCRIÇÃO: Carrega ícones do arquivo JSON traduzido e transforma para estrutura hierárquica.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Obter Páginas Hierárquicas (GetPaginasHierarquico)
        /// │ DESCRIÇÃO: Retorna lista de páginas do sistema em formato hierárquico.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        [HttpGet]
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: LoadPaginasFromFileSystem
        /// │ DESCRIÇÃO: Varre a pasta de Pages para obter a estrutura do sistema.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        ...
        /// <summary>
        /// ╭──────────────────────────────────────────────────────────────────────────────
        /// │ FUNCIONALIDADE: Obter Menu de Navegação (GetNavigationMenu)
        /// │ DESCRIÇÃO: Retorna o HTML renderizado da navegação lateral para atualização dinâmica.
        /// │──────────────────────────────────────────────────────────────────────────────
        /// </summary>
        [HttpGet]
