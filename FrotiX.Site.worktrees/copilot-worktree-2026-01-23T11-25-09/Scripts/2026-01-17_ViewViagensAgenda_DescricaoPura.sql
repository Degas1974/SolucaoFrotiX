-- ================================================================
-- SCRIPT: Atualização da View ViewViagensAgenda
-- Data: 17/01/2026
-- Descrição: Adiciona campo DescricaoPura para tooltips da Agenda
--
-- MOTIVO: A tooltip da agenda estava mostrando no campo "Descrição"
-- o conteúdo antigo (motorista + placa + descrição concatenados).
-- Agora o campo DescricaoPura retorna APENAS a descrição da viagem.
-- ================================================================

PRINT 'Atualizando view dbo.ViewViagensAgenda...'
GO
...
-- Última alteração: 17/01/2026 - Adicionado campo DescricaoPura para tooltips
-- ================================================================
...
SELECT
    ...
    -- ============================================================
    -- DESCRIÇÃO PURA (apenas o campo Descricao da viagem, sem motorista/placa)
    -- Adicionado em 17/01/2026 para tooltips customizadas
    -- ============================================================
    DescricaoPura = CASE
        WHEN v.DescricaoSemFormato IS NOT NULL AND LEN(LTRIM(RTRIM(CAST(v.DescricaoSemFormato AS VARCHAR(MAX))))) > 0
        THEN REPLACE(
                REPLACE(
                    REPLACE(
                        CAST(v.DescricaoSemFormato AS VARCHAR(MAX)),
...
PRINT 'View dbo.ViewViagensAgenda atualizada com sucesso!'
PRINT 'Novo campo: DescricaoPura - retorna apenas a descrição da viagem sem motorista/placa'
GO
