...
class ValidadorAgendamento {
    ...
    async validarDataInicial() {
        try {
            ...
            const kendoDatePicker = $("#txtDataInicial").data("kendoDatePicker");
            ...
            if (kendoDatePicker) {
                ...
                if (txtDataInicial && (!txtDataInicial.value || txtDataInicial.value === "")) {
    ...
    async validarRecorrencia() {
        try {
            ...
            const recorrente = lstRecorrenteKendo ? lstRecorrenteKendo.value() : null;
    ...
    async validarPeriodoRecorrencia() {
        try {
            ...
            if ((periodo === "D" || periodo === "S" || periodo === "Q" || periodo === "M")) {
                ...
                const dataFinal = txtFinalRecorrencia ? txtFinalRecorrencia.value?.trim() : "";
