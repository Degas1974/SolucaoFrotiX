...
(function ()
{
    ...
    {
        console.log('[Relatório] ✅ Aguardando 2 segundos antes de remover overlay...');
                    ...
                    if ($viewer.length > 0)
                    {
                        ...
                        if (instance)
                        {
                            ...
                            try
                            {
                                ...
                                const isInitialized = instance.reportSource &&
                                ...
                                {
                                    console.log('[Relatório] ⚠️ Viewer não inicializado completamente, pulando dispose');
                                }
                            ...
                            } catch (e)
                            {
                                ...
                                if (e.message && e.message.includes('collapsible'))
                                {
                                    console.log('[Relatório] ⚠️ Kendo não inicializado, ignorando erro');
                                }
                                else
                                {
