...
function initCalendarioAlerta() {
    try {
        ...
        if (typeof ej === 'undefined' || typeof ej.calendars === 'undefined' || typeof ej.calendars.Calendar === 'undefined') {
            console.warn('⚠️ Syncfusion Calendar não está disponível ainda. Tentando novamente em 500ms...');
            setTimeout(function() {
                initCalendarioAlerta();
            }, 500);
            return;
        ...
        var localeToUse = 'en';
        try {
            if (typeof ej.base !== 'undefined' && typeof ej.base.L10n !== 'undefined') {
        ...
        calendarioAlertaInstance = new ej.calendars.Calendar({
            ...
            change: function (args) {
                try {
                    ...
                    Alerta.TratamentoErroComLinha('alertas_recorrencia.js', 'calendarioAlerta.change', error);
                }
            }
        });
        ...
        Alerta.TratamentoErroComLinha('alertas_recorrencia.js', 'initCalendarioAlerta', error);
    }
}
