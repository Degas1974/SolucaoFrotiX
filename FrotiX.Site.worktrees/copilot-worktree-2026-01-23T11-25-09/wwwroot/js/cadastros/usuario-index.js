                ...
                columns: [
                    {
                        ...
                        render: function (data, type, row) {
                            try {
                                ...
                                // Para exibição, renderizar com avatar
                                const foto = row.fotoBase64;

                                let avatarHtml = '';
                                if (foto && foto.trim() !== '') {
                                    // Avatar com foto - classe is-visible para exibir (CSS oculta por padrão)
                                    ...
                                    // Avatar sem foto - ícone de usuário
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            try {
                                ...
                                // Botão Recursos (sempre habilitado)
                                ...
                                // Botão Foto (habilitado/desabilitado)
                                let btnFoto = '';
                                if (temFoto) {
                                    ...
                                    // Botão desabilitado com wrapper para tooltip
                                ...
                                // Botão Excluir (habilitado/desabilitado)
                                let btnExcluir = '';
                                if (podeExcluir) {
