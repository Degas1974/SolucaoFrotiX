...
**Mudanca:** GRANDE | **+196** linhas | **-227** linhas

---

```diff
--- JANEIRO: wwwroot/js/whatsapp.js
+++ ATUAL: wwwroot/js/whatsapp.js
@@ -1,291 +1,260 @@
-(function () {
-    try {
...
-                    AppToast.show(
-                        'Verde',
-                        r.message || 'Sessão iniciada. Cheque o QR.',
-                        3000,
-                    );
-                } else {
-                    AppToast.show(
-                        'Vermelho',
-                        r?.message || 'Falha ao iniciar sessão',
-                        4000,
-                    );
-                }
-            } catch (error) {
...
-                    AppToast.show(
-                        'Amarelo',
-                        'QR disponível. Escaneie no celular.',
-                        3000,
-                    );
...
-                } else {
-                    setQrMessage(
-                        'QR ainda não gerado. Tente novamente em alguns segundos.',
-                    );
-                }
-            } catch (error) {
...
-                );
-                r?.success
-                    ? AppToast.show('Verde', 'Mídia enviada!', 3000)
-                    : AppToast.show(
-                          'Vermelho',
-                          r?.message || 'Falha ao enviar',
-                          4000,
