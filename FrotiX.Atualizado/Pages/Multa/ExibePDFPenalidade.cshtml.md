...
```diff
--- JANEIRO: Pages/Multa/ExibePDFPenalidade.cshtml
+++ ATUAL: Pages/Multa/ExibePDFPenalidade.cshtml
@@ -45,8 +45,10 @@
...
-            /**
-             * ═══════════════════════════════════════════════════════════════════════════
-             * EXIBE PDF PENALIDADE - VISUALIZADOR DE DOCUMENTO
-             * ═══════════════════════════════════════════════════════════════════════════
-             * @@description Carrega e exibe PDF de penalidade de multa.
-             * @@requires Syncfusion PdfViewer, AppToast
-            * @@file Multa / ExibePDFPenalidade.cshtml
-            */
