...
**Mudanca:** GRANDE | **+331** linhas | **-357** linhas

---

```diff
--- JANEIRO: Pages/Intel/MarketingDashboard.cshtml
+++ ATUAL: Pages/Intel/MarketingDashboard.cshtml
@@ -7,31 +7,29 @@
     ViewData["Heading"] = "<i class='subheader-icon fa-duotone fa-chart-area'></i> Marketing <span class='fw-300'>Dashboard</span>";
 }
 @section HeadBlock {
...
-            <i class="@(Settings.Theme.IconPrefix) fa-user position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n1"
...
-            <i class="@(Settings.Theme.IconPrefix) fa-gem position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n4"
-                style="font-size: 6rem;"></i>
...
-            <i class="@(Settings.Theme.IconPrefix) fa-lightbulb position-absolute pos-right pos-bottom opacity-15 mb-n5 mr-n6"
...
-            <i class="@(Settings.Theme.IconPrefix) fa-globe position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n4"
-                style="font-size: 6rem;"></i>
...
-                                        <i
-                                            class="@(Settings.Theme.IconPrefix) fa-arrow-up icon-stack-1x opacity-100 color-white"></i>
...
-                                    <a href='#'' class='btn btn-sm btn-icon btn-outline-primary rounded-circle shadow-0' data-bs-toggle='dropdown' aria-expanded='true' title='More options'>
...
-                    var plot2 = null;
-                    /**
-                     * Atualiza gráfico Flot com séries selecionadas via checkboxes
-                     * @@description Coleta checkboxes marcados, monta array de dados e redesenha gráfico
-                     * @@returns {void}
-                     */
-                    function plotNow() {
-                        var d = [];
