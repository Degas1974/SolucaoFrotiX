/* ╔════════════════════════════════════════════════════════════════════════════════════════════════════╗
   ...
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
   ║ 🎯 OBJETIVO: Entidade e ViewModels para tipos de combustível (Gasolina, Diesel, Etanol, etc.).     ║
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
   ║ 📋 CLASSES: Combustivel (CombustivelId, Descricao, Status), CombustivelViewModel, MediaCombustivel ║
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
