/* ╔════════════════════════════════════════════════════════════════════════════════════════════════════╗
   ...
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
   ║ 🎯 OBJETIVO DO ARQUIVO:                                                                            ║
   ║    Modelos para cadastro de eventos (cerimônias, reuniões, etc.).                                 ║
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
   ║ 📋 CLASSES DISPONÍVEIS:                                                                           ║
   ║    • Evento                                                                                       ║
   ║    • Evento.EventoViewModel                                                                       ║
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
...
namespace FrotiX.Models
    ...
    //
    // 🎯 OBJETIVO:
    // Representar evento e seus dados principais para cadastro.
    //
    // 🔗 RASTREABILIDADE:
    // ⬅️ CHAMADO POR : Controllers/Views de eventos
    ...
    public class Evento
        ...
        //
        // 🎯 OBJETIVO:
        // Agrupar dados do evento para uso em telas e operações de cadastro.
        //
        // 🔗 RASTREABILIDADE:
        // ⬅️ CHAMADO POR : Controllers/Views de eventos
        // ➡️ CHAMA       : Evento
