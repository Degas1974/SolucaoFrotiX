/* ╔════════════════════════════════════════════════════════════════════════════════════════════════════╗
   ║ 🚀 ARQUIVO: FileTrackingService.cs                                                                  ║
   ║ 📂 CAMINHO: /Services/DocGenerator/Services                                                         ║
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
   ║ 🎯 OBJETIVO: Rastreamento de mudanças em arquivos. Cache de hashes, alertas de doc desatualizada.   ║
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
   ║ 📋 ÍNDICE: NeedsUpdateAsync(), DetectChangesAsync(), MarkAsDocumentedAsync(), RunAutoScanAsync()    ║
   ║ 🔗 DEPS: Dapper, IHostedService (background) | 📅 15/01/2026 | 👤 Copilot | 📝 v2.0                 ║
   ╚════════════════════════════════════════════════════════════════════════════════════════════════════╝
*/
