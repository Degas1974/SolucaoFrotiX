/* ╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
   ...
   ║ 🎯 OBJETIVO: Repositório especializado para gerenciar eventos/solenidades com queries otimizadas              ║
   ║ 📋 MÉTODOS:                                                                                                    ║
   ║    • GetEventoListForDropDown() → SelectList ordenada por nome                                                ║
   ║    • GetEventosPaginadoAsync() → Query otimizada com JOIN e cálculo de custos em batch                        ║
   ║    • Update() → Atualização direta da entidade Evento                                                         ║
   ║ 🔗 DEPS: Repository<Evento>, IEventoRepository, FrotiXDbContext, SelectListItem, AsNoTracking, Stopwatch      ║
   ║ ⚡ OTIMIZAÇÕES: Custos GroupBy batch | AsNoTracking read-only | Performance logs                              ║
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
