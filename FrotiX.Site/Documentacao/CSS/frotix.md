...
**25/01/2026** - Versão 3.0

- **NOVA FUNCIONALIDADE**: Estilização global de botões e paginação do DataTables
- **Objetivo**: Padronizar aparência de TODOS os DataTables do sistema com botões laranjas (padrão FrotiX)
- **Componentes estilizados**:
  1. **Botões de ação superiores** (.dt-button): Excel, PDF, "Mostrar X registros"
  2. **Botões de paginação** (.paginate_button): Anterior, números de página, Próximo
  3. **Dropdowns** (.dt-button-collection): Menu de seleção de quantidade de registros
- **Cores implementadas**:
  - Botões normais: Gradiente laranja escuro (#cc5200 → #b34700)
  - Hover: Gradiente mais escuro (#b34700 → #a03d00)
  - Página ativa: Gradiente ainda mais escuro (#a03d00 → #8a3300) + negrito + borda
  - Desabilitados: Cinza (#e0e0e0) sem interação
- **Efeitos visuais**:
  - Transições suaves (0.3s ease)
  - Elevação ao hover (translateY(-1px))
...
- **Benefícios**:
  - ✅ Estilização automática de TODOS os DataTables (novos e existentes)
  - ✅ Consistência visual em todo o sistema
  - ✅ Zero código CSS duplicado em páginas individuais
  - ✅ Manutenção centralizada (mudar cores em um só lugar)
  - ✅ Alinhamento com identidade visual FrotiX (laranja corporativo)
- **Impacto**: Todas as páginas com DataTables agora têm botões padronizados sem necessidade de CSS local
