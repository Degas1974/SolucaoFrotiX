/* ****************************************************************************************
 * ⚡ ARQUIVO: Pages/Encarregado/Index.cshtml.cs
 * --------------------------------------------------------------------------------------
 * 🎯 OBJETIVO     : PageModel (code-behind) da página de listagem de Encarregados.
 *                   Inicializa a página Index.cshtml sem lógica específica (lógica no frontend).
 * 📥 ENTRADAS     : GET request para rota /Encarregado, método OnGet() chamado pelo ASP.NET Core
 * 📤 SAÍDAS       : Renderização de Index.cshtml, sem ViewData ou Model específico (PageModel vazio)
 * 🔗 CHAMADA POR  : ASP.NET Core Razor Pages pipeline ao acessar /Encarregado, Index.cshtml
 ...
 * 📝 OBSERVAÇÕES  : PageModel minimalista - toda lógica CRUD está no JavaScript (encarregado.js)
 *                   e Controller (/api/Encarregado). OnGet() vazio com try-catch preventivo.
