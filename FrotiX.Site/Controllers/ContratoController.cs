 ...
 * ║  • Lógica de exclusão com limpeza de relacionamentos                    ║
    ...
    public partial class ContratoController :Controller
    {
        ...
        public IActionResult Get()
        {
            try
            {
                ...
                // Busca contagens de dependências para todos os contratos
                var contratoIds = contratos.Select(c => c.ContratoId).ToList();

                // Contagens por contrato (com try/catch para cada tipo)
                ...
                // Conta itens de contrato via join com RepactuacaoContrato
                try
                {
                    ...
                    // Agrupa por ContratoId através da repactuação
