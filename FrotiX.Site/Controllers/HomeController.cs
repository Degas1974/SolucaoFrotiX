...
╠══════════════════════════════════════════════════════════════════════════════╣
║ DESCRICAO                                                                    ║
║ Controller da pagina inicial (Home/Dashboard). Fornece dados para            ║
║ grids de demonstracao/testes (OrdersDetails) e view principal.               ║
╠══════════════════════════════════════════════════════════════════════════════╣
║ ENDPOINTS                                                                    ║
║ - GET  /Home/Index : Pagina inicial do sistema                               ║
╠══════════════════════════════════════════════════════════════════════════════╣
