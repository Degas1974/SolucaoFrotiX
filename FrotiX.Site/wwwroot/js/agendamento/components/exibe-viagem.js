    ...
    try
    {
        ...
        setTimeout(() =>
        {
            ...
            */
            ...
            // ============================================
            // 14. HABILITAR RECORRÊNCIA E MOSTRAR CARD
            // ============================================
...
function configurarRecorrenciaSemanal(objViagem)
{
    try
    {
        ...
        {
            /**
             * Em modo de edição, usar campo de texto em vez de DatePicker Syncfusion
             * Motivo: DatePicker não renderiza corretamente no primeiro carregamento do modal
             * Solução: Exibir data formatada em campo de texto readonly
             */
            try
            {
                const txtFinalRecorrencia = document.getElementById("txtFinalRecorrencia");
