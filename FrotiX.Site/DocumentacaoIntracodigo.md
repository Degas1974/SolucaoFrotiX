...
| Documentados | 749 |
| Percentual | 77.5% |
| Última Atualização | 02/02/2026 15:00 |
...
| 19 | **JavaScript** | **132** | **39** | **29.5%** | 🟡 **Em Progresso** |
...
✅ Models/Cadastros - Classes (Lote 114 - novo padrão visual):
   • Operador.cs
   • OperadorContrato.cs
   • OrgaoAutuante.cs
   • Patrimonio.cs
...
✅ Models/Cadastros - Classes (Lote 116 - novo padrão visual):
   • SetorSolicitante.cs
   • TipoMulta.cs
   • Unidade.cs
   • Veiculo.cs
...
✅ Models - Classes (Lote 119 - novo padrão visual):
   • ErrorViewModel.cs
   • EventoListDto.cs
   • ForgotAccount.cs
   • INavigationModel.cs
...
✅ Models - Classes (Lote 121 - novo padrão visual):
   • RecursoTreeDTO.cs
...
✅ Areas/Authorization + Areas/Identity - Pages (Lote 133 - revisão cards completos):
   • Usuarios.cshtml.cs
   • _ViewImports.cshtml
   • _ViewStart.cshtml
   • ConfirmEmail.cshtml
...
✅ Areas/Identity - Pages (Lote 134 - revisão cards completos):
...
✅ Areas/Identity - Pages (Lote 137 - revisão cards completos):
   • Register.cshtml.cs
...
✅ Controllers - Classes (Lote 143 - revisão cards completos):
...
✅ Controllers - Classes (Lote 144 - revisão cards completos):
...
✅ Controllers - Classes (Lote 145 - revisão cards completos):
   • EscalaController.cs
   • EscalaController_Api.cs
   • FornecedorController.cs
   • GlosaController.cs
   • GridAtaController.cs

✅ Controllers - Classes (Lote 146 - revisão cards completos):
...
✅ Controllers - Classes (Lote 147 - revisão cards completos):
   • LoginController.cs
...
✅ Controllers - Classes (Lote 148 - revisão cards completos):
   • MultaController.cs
...
✅ Controllers - Classes (Lote 149 - revisão cards completos):
...
✅ Controllers - Classes (Lote 151 - revisão cards completos):
...
✅ Controllers - Classes (Lote 153 - revisão cards completos):
...
✅ Controllers - Classes (Lote 154 - revisão cards completos):
...
✅ Controllers - Classes (Lote 155 - revisão cards completos):
...
✅ Models - Classes (Lote 160 - revisão cards completos):
   • AlertasFrotiX.cs
   • Abastecimento.cs
   • Agenda.cs
   • AspNetUsers.cs
...
✅ Models - Classes (Lote 162 - revisão cards completos):
   • CorridasTaxiLegCanceladas.cs
   • DeleteMovimentacaoWrapper.cs
   • Empenho.cs
   • EmpenhoMulta.cs
...
✅ Models - Classes (Lote 163 - revisão cards completos):
   • Escalas.cs
   • Evento.cs
   • FiltroEscala.cs
   • Fornecedor.cs
...
✅ Models - Classes (Lote 164 - revisão cards completos):
   • ItensManutencao.cs
   • Lavador.cs
   • LavadorContrato.cs
   • LavadoresLavagem.cs
...
✅ Models - Classes (Lote 165 - revisão cards completos):
   • LotacaoMotorista.cs
   • Manutencao.cs
   • MarcaVeiculo.cs
   • ModeloVeiculo.cs
...
✅ Models - Classes (Lote 166 - revisão cards completos):
   • MotoristaContrato.cs
   • MovimentacaoEmpenho.cs
   • MovimentacaoEmpenhoMulta.cs
   • MovimentacaoPatrimonio.cs
...
✅ Models - Classes (Lote 169 - revisão cards completos):
   • SecaoPatrimonial.cs
   • SetorPatrimonial.cs
   • SetorSolicitante.cs
   • TipoMulta.cs
...
✅ Models + Models/DTO - Classes (Lote 171 - revisão cards completos):
   • ContractDropDownItem.cs
   • EstatisticaVeiculoDto.cs
   • HigienizacaoDto.cs
   • LookupsDto.cs
...
✅ Models - Classes (Lote 173 - revisão cards completos):
   • DateItem.cs
   • Encarregado.cs
   • EncarregadoContrato.cs
   • ErrorViewModel.cs
...
✅ Models - Classes (Lote 179 - revisão cards completos):
   • SmartSettings.cs
   • TempDataExtensions.cs
   • ToastMessage.cs
   • VeiculoPadraoViagem.cs
...
✅ Models + Models/Views - Classes (Lote 180 - revisão cards completos):
   • ViewOcorrenciasViagem.cs
   • ViewAbastecimentos.cs
   • ViewAtaFornecedor.cs
...
✅ Areas/Identity - Pages (Lote 126 - novo padrão visual):
   • ConfirmEmailChange.cshtml
   • ConfirmEmailChange.cshtml.cs
   • ForgotPassword.cshtml
   • ForgotPassword.cshtml.cs
...
✅ Areas/Identity - Pages (Lote 129 - novo padrão visual):
   • Register.cshtml.cs
   • RegisterConfirmation.cshtml
   • RegisterConfirmation.cshtml.cs
   • ResetPassword.cshtml
...
✅ Areas/Identity - Pages (Lote 130 - novo padrão visual):
   • ResetPasswordConfirmation.cshtml
   • ResetPasswordConfirmation.cshtml.cs
   • _ViewImports.cshtml
   • ConfirmarSenha.cshtml
...
| 31/01/2026 | 5 | 1 | Lote 143 - Controllers revisão cards completos (5 arquivos) |
| 31/01/2026 | 5 | 1 | Lote 144 - Controllers revisão cards completos (5 arquivos) |
| 31/01/2026 | 5 | 1 | Lote 145 - Controllers revisão cards completos (5 arquivos) |
| 31/01/2026 | 5 | 1 | Lote 146 - Controllers revisão cards completos (5 arquivos) |
...
| 31/01/2026 | 5 | 1 | Lote 162 - Models revisão cards completos (5 arquivos) |
| 31/01/2026 | 5 | 1 | Lote 163 - Models revisão cards completos (5 arquivos) |
