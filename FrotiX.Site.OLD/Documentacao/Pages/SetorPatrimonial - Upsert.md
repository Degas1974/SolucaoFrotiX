# Documentação: SetorPatrimonial - Upsert
...
- **JS** (3):
  ...
  - `~/js/cadastros/setor_patrimonial.js`
  - `~/js/dropify.min.js`
...
- Pages/SetorPatrimonial/Upsert.cshtml - Substituição de `btn-ftx-fechar` por `btn-vinho` em botão de modal
