# Documentação: ModeloVeiculo - Upsert
...
- **Módulo**: `ModeloVeiculo`
- **Página**: `Upsert`
- **Rota (Razor Pages)**: `/<convenção Razor Pages>`
- **@model**: `FrotiX.Pages.ModeloVeiculo.UpsertModel`
...
**Arquivos Afetados**:
- Pages/ModeloVeiculo/Upsert.cshtml - Substituição de `btn-ftx-fechar` por `btn-vinho` em botão de modal
