# Documentação: _ScriptsBasePlugins.cshtml
...
**Solução**: Dados CLDR inline carregados síncronamente:
...
Traduções para componentes específicos (PDFViewer, Uploader, DatePicker, etc.) são carregadas após o CLDR base.
