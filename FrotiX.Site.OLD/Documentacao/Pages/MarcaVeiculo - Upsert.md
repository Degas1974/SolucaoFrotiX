# Documentação: MarcaVeiculo - Upsert
...
- **@model**: `FrotiX.Pages.MarcaVeiculo.UpsertModel`
...
**Arquivos Afetados**:
- Pages/MarcaVeiculo/Upsert.cshtml - Substituição de `btn-ftx-fechar` por `btn-vinho` em botão de modal
