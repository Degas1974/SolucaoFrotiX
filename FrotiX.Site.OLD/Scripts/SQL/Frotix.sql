...
-- Script date 13/02/2026 20:08:22
...
--
-- Create table [dbo].[Viagem_Backup_OrigemDestino]
--
PRINT (N'Create table [dbo].[Viagem_Backup_OrigemDestino]')
GO
CREATE TABLE dbo.Viagem_Backup_OrigemDestino (
  ViagemId uniqueidentifier NOT NULL,
  OrigemOriginal varchar(max) NULL,
  DestinoOriginal varchar(max) NULL,
...
--
-- Create index [IX_Recurso_NomeMenu] on table [dbo].[Recurso]
--
PRINT (N'Create index [IX_Recurso_NomeMenu] on table [dbo].[Recurso]')
GO
CREATE INDEX IX_Recurso_NomeMenu
...
--
-- Create index [UK_Recurso_Nome] on table [dbo].[Recurso]
--
PRINT (N'Create index [UK_Recurso_Nome] on table [dbo].[Recurso]')
GO
CREATE UNIQUE INDEX UK_Recurso_Nome
  ON dbo.Recurso (Nome)
  ON [PRIMARY]
GO
...
--
-- Create or alter trigger [trg_MovimentacaoEmpenhoMulta_ValidaReferencias] on table [dbo].[MovimentacaoEmpenhoMulta]
--
GO
PRINT (N'Create or alter trigger [trg_MovimentacaoEmpenhoMulta_ValidaReferencias] on table [dbo].[MovimentacaoEmpenhoMulta]')
GO
...
--
-- Create or alter trigger [trg_Lavador_ValidaReferencias] on table [dbo].[Lavador]
--
GO
PRINT (N'Create or alter trigger [trg_Lavador_ValidaReferencias] on table [dbo].[Lavador]')
GO
...
--
-- Create or alter trigger [trg_Manutencao_ValidaUsuarios] on table [dbo].[Manutencao]
--
GO
PRINT (N'Create or alter trigger [trg_Manutencao_ValidaUsuarios] on table [dbo].[Manutencao]')
GO
...
--
-- Create or alter trigger [trg_Motorista_ValidaReferencias] on table [dbo].[Motorista]
--
GO
PRINT (N'Create or alter trigger [trg_Motorista_ValidaReferencias] on table [dbo].[Motorista]')
GO
...
--
-- Create index [IX_Lavagem_VeiculoId_Data] on table [dbo].[Lavagem]
--
PRINT (N'Create index [IX_Lavagem_VeiculoId_Data] on table [dbo].[Lavagem]')
GO
CREATE INDEX IX_Lavagem_VeiculoId_Data
  ON dbo.Lavagem (VeiculoId, Data DESC)
...
CREATE TABLE dbo.Viagem (
  ...
  ArlaEntregue bit NULL DEFAULT (0),
  ArlaDevolvido bit NULL DEFAULT (0),
  CaboEntregue bit NULL DEFAULT (0),
  CaboDevolvido bit NULL DEFAULT (0),
  SuporteIntegro bit NULL DEFAULT (0),
  SuporteDefeituoso bit NULL DEFAULT (0),
...
--
-- Create or alter trigger [trg_Viagem_ValidaUsuarios] on table [dbo].[Viagem]
--
GO
PRINT (N'Create or alter trigger [trg_Viagem_ValidaUsuarios] on table [dbo].[Viagem]')
GO
...
--
-- Create or alter trigger [trg_ItensManutencao_ValidaReferencias] on table [dbo].[ItensManutencao]
--
GO
PRINT (N'Create or alter trigger [trg_ItensManutencao_ValidaReferencias] on table [dbo].[ItensManutencao]')
GO
...
--
-- Create or alter trigger [trg_AlertasFrotiX_ValidaUsuarios] on table [dbo].[AlertasFrotiX]
--
GO
PRINT (N'Create or alter trigger [trg_AlertasFrotiX_ValidaUsuarios] on table [dbo].[AlertasFrotiX]')
GO
