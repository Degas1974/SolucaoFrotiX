/* ╔════════════════════════════════════════════════════════════════════════════════════════════════════╗
    ...
    ║ 📂 CAMINHO: /Repository                                                                             ║
    ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
    ║ 🎯 OBJETIVO: Repositório de alertas e notificações do FrotiX (consultas e marcação de leitura).    ║
    ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
    ║ 📋 MÉTODOS: GetTodosAlertasAtivosAsync(), GetQuantidadeAlertasNaoLidosAsync(), MarcarComoLidoAsync()║
    ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
