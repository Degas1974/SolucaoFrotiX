/* ╔════════════════════════════════════════════════════════════════════════════════════════════════════╗
    ...
    ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
    ║ 🎯 OBJETIVO: View SQL de viagens para agenda/calendário (status e horários).                       ║
    ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
    ║ 📋 PROPS: ViagemId, DataInicial, HoraInicio, Status, StatusAgendamento, Finalidade, NomeEvento     ║
    ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
