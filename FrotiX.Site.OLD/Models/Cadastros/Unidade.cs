 ...
 *
 * 📥 ENTRADAS     : Dados de contato, categoria e status da unidade.
 *
 * 📤 SAÍDAS       : Entidade persistida e ViewModel para UI.
 *
 * 🔗 CHAMADA POR  : Cadastros de unidades e alocação de motoristas.
 *
...
{
    /****************************************************************************************
     * ⚡ VIEWMODEL: UnidadeViewModel
     * --------------------------------------------------------------------------------------
     * 🎯 OBJETIVO     : Transportar a chave da unidade em operações simples.
     *
     * 📥 ENTRADAS     : UnidadeId.
     *
     * 📤 SAÍDAS       : ViewModel simplificado para UI.
     *
     * 🔗 CHAMADA POR  : Controllers/Views de unidades.
     ****************************************************************************************/
     ...
     * ⚡ MODEL: Unidade
     * --------------------------------------------------------------------------------------
     * 🎯 OBJETIVO     : Representar uma unidade do órgão (base operacional).
     *
     * 📥 ENTRADAS     : Sigla, contatos e categoria.
     *
     * 📤 SAÍDAS       : Registro persistido de unidade.
     *
