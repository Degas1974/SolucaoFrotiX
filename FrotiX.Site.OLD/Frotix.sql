...
-- Script date 14/01/2026 23:37:56
...
-- Última alteração: 16/01/2026 - Cor do Evento alterada para #A39481 (20% mais clara)
-- ================================================================
...
CREATE TABLE DocGenerator.FileTracking (
    ...
    CONSTRAINT UQ_FilePath UNIQUE (FilePath)
);
...
CREATE TABLE DocGenerator.FileChangeHistory (
    ...
    INDEX IX_DetectedAt (DetectedAt)
);
...
CREATE INDEX IX_FileTracking_NeedsUpdate ON DocGenerator.FileTracking (NeedsUpdate);
CREATE INDEX IX_FileTracking_LastModified ON DocGenerator.FileTracking (LastModified);
...
PRINT 'ðŸ“Š Tabelas: FileTracking, FileChangeHistory, DocumentationAlerts, MonitoringConfig';
