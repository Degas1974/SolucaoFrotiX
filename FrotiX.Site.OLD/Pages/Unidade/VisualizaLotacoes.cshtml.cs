...
// ╠══════════════════════════════════════════════════════════════════════════════╣
// ║ ARQUIVO    : VisualizaLotacoes.cshtml.cs                                     ║
// ║ LOCALIZAÇÃO: Pages/Unidade/                                                  ║
// ║ FINALIDADE : PageModel para visualização de lotações de motoristas.          ║
// ╠══════════════════════════════════════════════════════════════════════════════╣
// ║ DESCRIÇÃO: Exibe distribuição de motoristas por unidade organizacional.       ║
// ╠══════════════════════════════════════════════════════════════════════════════╣
// ║ LOTE: 23 — Pages/Unidade | DATA: 29/01/2026                                  ║
// ╚══════════════════════════════════════════════════════════════════════════════╝
