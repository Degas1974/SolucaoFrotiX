 ...
 * ║ Arquivo: PBILotacaoMotorista.cshtml.cs (Pages/Motorista - namespace Viagens)                             ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ DESCRIÇÃO                                                                                                 ║
 * ║ PageModel para registro de viagens relacionadas a lotação de motoristas. Similar ao Upsert.cshtml.cs    ║
 * ║ mas focado em contexto de lotação/designação temporária de motoristas para unidades.                    ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ NOTA: NAMESPACE INCONSISTENTE                                                                             ║
 * ║ • Arquivo está em Pages/Motorista mas namespace é FrotiX.Pages.Viagens                                  ║
 ...
 * ║ • OnPostSubmit() : Cria nova viagem com custos calculados                                                ║
...
namespace FrotiX.Pages.Viagens
{
    public class PBILotacaoMotoristaModel : PageModel
    {
        ...
        public PBILotacaoMotoristaModel(
        ...
        )
        {
            ...
            catch (Exception error)
            {
                Alerta.TratamentoErroComLinha(
                    "PBILotacaoMotorista.cshtml.cs",
                    "PBILotacaoMotoristaModel",
                    error
                );
            }
        }
        ...
        public static void ConvertTo(HtmlNode node, TextWriter outText)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBILotacaoMotorista.cshtml.cs", "ConvertTo", error);
                return; // padronizado
            }
        }
        ...
        public IActionResult OnGet(Guid id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBILotacaoMotorista.cshtml.cs", "OnGet", error);
                return Page();
            }
        }
        ...
        public IActionResult OnPostEdit(Guid Id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBILotacaoMotorista.cshtml.cs", "OnPostEdit", error);
                return RedirectToPage("./Index");
            }
        }
