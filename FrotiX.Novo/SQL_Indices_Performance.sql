-- ============================================================================
-- SQL PARA CRIAR ÍNDICES DE PERFORMANCE - COMPLETO
-- ============================================================================
--
-- Este script cria índices otimizados para melhorar a performance de consultas
-- no banco de dados FrotiX.
--
...
-- - Monitore o uso de índices após criação (veja queries de monitoramento no final)
-- - Índices melhoram SELECT mas podem reduzir performance de INSERT/UPDATE/DELETE
-- - Faça BACKUP do banco antes de executar em PRODUÇÃO
--
-- Estatísticas:
-- - Índices Sugeridos: 24
-- - Prioridade ALTA: 4
-- - Prioridade MÉDIA: 6
-- - Prioridade BAIXA: 14
--
...
PRINT '============================================================================'
PRINT 'ÍNDICES DE PERFORMANCE - IMPLEMENTAÇÃO COMPLETA'
PRINT '============================================================================'
PRINT ''
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_ItemVeiculoAta_VeiculoId')
BEGIN
    CREATE INDEX IX_ItemVeiculoAta_VeiculoId
    ON dbo.ItemVeiculoAta (VeiculoId)
    WHERE VeiculoId IS NOT NULL;
    PRINT '✅ IX_ItemVeiculoAta_VeiculoId criado'
END
ELSE PRINT '✓  IX_ItemVeiculoAta_VeiculoId já existe'
GO
