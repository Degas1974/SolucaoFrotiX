 ...
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║ ❓ POR QUE EXISTO?                                                       ║
 * ║    Kendo Editor Helper para formulário de Viagens.                       ║
 * ║    • Camada de compatibilidade Syncfusion → Kendo                       ║
 * ║    • Editor WYSIWYG para observações                                     ║
 * ║    • Sanitização de conteúdo HTML                                        ║
 * ║                                                                          ║
 * ║ 🔗 RELEVÂNCIA: Média (Viagens - Editor)                                   ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 */
