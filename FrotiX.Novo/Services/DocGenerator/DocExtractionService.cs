/* ╔════════════════════════════════════════════════════════════════════════════════════════════════════╗
   ║ 🚀 ARQUIVO: DocExtractionService.cs                                                                 ║
   ║ 📂 CAMINHO: /Services/DocGenerator                                                                  ║
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
   ║ 🎯 OBJETIVO: Extração de metadados de arquivos usando Roslyn e Regex. Analisa C#, JS, CSHTML.       ║
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
   ║ 📋 ÍNDICE: ExtractAsync(), ParseCSharpFile(), ParseRazorFile(), ExtractMethods(), ExtractClasses()  ║
   ║ 🔗 DEPS: IDocExtractionService, Microsoft.CodeAnalysis | 📅 13/01/2026 | 👤 Copilot | 📝 v2.0       ║
   ╚════════════════════════════════════════════════════════════════════════════════════════════════════╝
*/
