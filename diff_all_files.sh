#!/bin/bash
# Script para comparar todos os arquivos listados entre FrotiX.Site e FrotiX.Site.Backup

SITE="c:/FrotiX/Solucao FrotiX 2026/FrotiX.Site"
BACKUP="c:/FrotiX/Solucao FrotiX 2026/FrotiX.Site.Backup"
...
"Pages/Administracao/DocGenerator.cshtml.cs"
...
"Pages/Contrato/Index.cshtml.cs"
...
"Pages/Motorista/Index.cshtml.cs"
...
"Repository/IRepository/IFrotiXRepository.cs"
...
"src/index.js"
"TextNormalization/Cache/ICacheStore.cs"
"TextNormalization/Cache/JsonCacheStore.cs"
"TextNormalization/Cache/ProperCacheModel.cs"
"TextNormalization/Core/NormalizerOptions.cs"
"TextNormalization/Core/SentenceCaseNormalizer.cs"
"TextNormalization/Extensions/TextNormalizationServiceCollectionExtensions.cs"
"TextNormalization/Facade/NormalizationService.cs"
"TextNormalization/Facade/TextNormalizationHelper.cs"
"TextNormalization/Repository/ProperDataRepository.cs"
"TextNormalization/Sources/Seeds/BrAcronymsSeed.cs"
"TextNormalization/Sources/Seeds/BrGivenNamesSeed.cs"
"TextNormalization/Sources/Seeds/BrSurnamesSeed.cs"
"TextNormalization/Sources/NamedEntitySources.cs"
"Tools/DocGenerator/obj/Debug/net9.0/.NETCoreApp,Version=v9.0.AssemblyAttributes.cs"
"Tools/DocGenerator/obj/Debug/net9.0/DocGenerator.AssemblyInfo.cs"
"Tools/DocGenerator/obj/Debug/net9.0/DocGenerator.GlobalUsings.g.cs"
"Tools/DocGenerator/Program.cs"
"ViewComponents/CustomViewModel.cs"
"ViewComponents/NavigationViewComponent.cs"
"ViewModels/Exportardashboardparapdfviewmodel.cs"
"Views/RelatorioSetorSolicitante/Index.cshtml"
...
"wwwroot/js/cadastros/recurso_001.js"
...
"wwwroot/js/loading_script.js"
"wwwroot/js/localization-init.js"
"wwwroot/js/modernizr-2.6.2.js"
"wwwroot/js/pdf-export-profissional.js"
...
echo "============================================"
echo "COMPARACAO FrotiX.Site vs FrotiX.Site.Backup"
echo "============================================"
echo "Total de arquivos a comparar: ${#FILES[@]}"
echo ""
...
for f in "${FILES[@]}"; do
  ...
  if [ ! -f "$SITE_FILE" ]; then
    ...
    MISSING_SITE_FILES="$MISSING_SITE_FILES\nMISSING_SITE|$f"
  elif [ ! -f "$BACKUP_FILE" ]; then
    MISSING_BACKUP=$((MISSING_BACKUP + 1))
    MISSING_BACKUP_FILES="$MISSING_BACKUP_FILES\nMISSING_BACKUP|$f"
  else
    if diff -q "$SITE_FILE" "$BACKUP_FILE" > /dev/null 2>&1; then
...
echo "RESUMO:"
echo "  Identicos:           $IDENTICAL"
echo "  Diferentes:          $DIFFERENT"
echo "  Ausentes em Site:    $MISSING_SITE"
echo "  Ausentes em Backup:  $MISSING_BACKUP"
echo ""
echo "============================================"
...
echo ""
echo "============================================"
echo "ARQUIVOS AUSENTES EM FrotiX.Site:"
echo "============================================"
echo -e "$MISSING_SITE_FILES"
echo ""
echo "============================================"
echo "ARQUIVOS AUSENTES EM FrotiX.Site.Backup:"
echo "============================================"
echo -e "$MISSING_BACKUP_FILES"
