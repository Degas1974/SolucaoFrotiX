...
using System.Linq;
using System.Runtime; // ⭐ OTIMIZAÇÃO: Para configuração de GC
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                // Adicionar compressão (desabilitado em Development para evitar warnings do BrowserLink/Refresh)
                if (!_environment.IsDevelopment())
                {
                    ...
                    {
                        options.Level = CompressionLevel.Fastest; // ⭐ OTIMIZAÇÃO: Fastest para melhor CPU vs compressão
                    });
                ...
                // ============================================
                // ⭐ OTIMIZAÇÃO: MEMORY CACHE COM LIMITE
                // ============================================
                services.AddMemoryCache(options =>
                {
                    options.SizeLimit = 1024; // Limite de 1024 entradas no cache
                });
                ...
                // ========================================================
                // 🔧 Toggle de Recorrência (via variáveis de ambiente)
                // ========================================================
                ...
                // ========================================================
                // ⭐ OTIMIZAÇÃO: BANCO DE DADOS COM RESILIÊNCIA E NO TRACKING
                // ========================================================
                ...
                services.AddDbContext<ApplicationDbContext>(options =>
                {
                    options.UseSqlServer(
                        ...
                        sql =>
                        {
                            // Resiliência para reconexão automática
                    ...
                    // CRÍTICO: Desabilitar tracking por padrão (economia de memoria)
                    // Use .AsTracking() explicitamente quando precisar fazer Update/Delete
                    options.UseQueryTrackingBehavior(QueryTrackingBehavior.NoTracking);

                    // Logging sensível (configurável via appsettings)
                ...
                // ============================================
                // ⭐ OTIMIZAÇÃO: SESSION COM SEGURANÇA
                // ============================================
                services.AddSession(options =>
                {
                    ...
                    options.Cookie.SecurePolicy = CookieSecurePolicy.Always; // ⭐ OTIMIZAÇÃO: Apenas HTTPS
                });
                ...
                services.AddScoped<ListaCacheService>();
            ...
            ILoggerFactory loggerFactory)
        {
            try
            {
                ...
                // UseResponseCompression apenas se o serviço foi registrado (não-Development)
                if (!_environment.IsDevelopment())
                {
                ...
                // ============================================
                // ⭐ OTIMIZAÇÃO: MIDDLEWARE DE LIMPEZA PERIÓDICA DE MEMÓRIA
                // ============================================
                app.Use(async (context, next) =>
                {
                    await next();

                    // GC probabilístico (1 em cada 50 requisições, ~2%)
                    // Evita acúmulo de memória sem impactar performance
