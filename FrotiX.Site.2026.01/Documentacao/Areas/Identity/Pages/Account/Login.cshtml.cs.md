# Login.cshtml.cs — PageModel do login padrão

> **Arquivo:** `Areas/Identity/Pages/Account/Login.cshtml.cs`  
> **Papel:** autenticação padrão com `SignInManager`.

---

## ✅ Visão Geral

Implementa fluxo tradicional de login com redirecionamento para o dashboard Intel.
...
- `ILogger<LoginModel>` para logs.
- `InputModel` com `Ponto`, `Password` e `RememberMe`.
...
- Suporta 2FA (`LoginWith2fa`) quando aplicável.
- Exibe erro de login inválido via `ModelState`.
