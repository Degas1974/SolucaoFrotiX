...
> **Arquivo:** `Areas/Identity/Pages/Account/Logout.cshtml.cs`  
> **Papel:** efetuar sign-out e redirecionar.

---

## ✅ Visão Geral

Desloga o usuário tanto no `OnGet` quanto no `OnPost`.
...
- Usa `SignInManager` diretamente para sign-out.
