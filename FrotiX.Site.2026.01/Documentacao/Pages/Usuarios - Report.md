...
- **CSS** (1):
  - `https://cdn.boldreports.com/embeddedreporting/commons/css/bold.reports.all.min.css`
- **JS** (2):
  - `https://cdn.boldreports.com/embeddedreporting/commons/scripts/bold.report-viewer.min.js`
  - `https://cdn.boldreports.com/embeddedreporting/commons/scripts/bold.reports.all.min.js`
