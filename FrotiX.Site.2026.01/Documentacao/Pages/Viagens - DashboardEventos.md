# Documentação: Viagens - DashboardEventos
...
- **Módulo**: `Viagens`
- **Página**: `DashboardEventos`
- **Rota (Razor Pages)**: `/<convenção Razor Pages>`
- **@model**: `FrotiX.Pages.Eventos.DashboardEventosModel`
...
- **CSS** (0):
- **JS** (5):
  - `https://cdn.syncfusion.com/ej2/26.2.14/dist/ej2-base.min.js`
  - `https://cdn.syncfusion.com/ej2/26.2.14/dist/ej2-charts.min.js`
  - `https://cdn.syncfusion.com/ej2/26.2.14/dist/ej2-data.min.js`
  - `https://cdn.syncfusion.com/ej2/26.2.14/dist/ej2-svg-base.min.js`
  - `~/js/dashboards/dashboard-eventos.js`
