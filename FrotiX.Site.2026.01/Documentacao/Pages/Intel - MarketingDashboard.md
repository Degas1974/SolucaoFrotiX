# Documentação: Intel - MarketingDashboard
...
- **JS** (4):
  ...
  - `~/js/statistics/peity/peity.bundle.js`
...
- ✅ Documentada 1 função: plotNow (atualização de gráfico Flot)
- ✅ Função possui @@description e @@returns
