# Documentação: Usuarios - UpsertRecurso
...
**Arquivos Afetados**:
- Pages/Usuarios/UpsertRecurso.cshtml - Substituição de `btn-ftx-fechar` por `btn-vinho` em botão de modal
