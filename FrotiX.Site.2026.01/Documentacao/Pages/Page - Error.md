...
- **CSS** (8):
  - `~/lib/fontawesome-pro/css/all.css`
...
- **JS** (8):
  ...
  - `~/Neon/js/gsap/TweenMax.min.js`
  - `~/Neon/js/joinable.js`
  - `~/Neon/js/jquery-1.11.3.min.js`
...
- ✅ Documentada função trimTransparentPNG (recorte de bordas transparentes em canvas)
- ✅ Função agora possui @@description, @@param e @@returns conforme padrão FrotiX
