...
<div class="ftx-card-header">
  ...
  <div class="ftx-card-actions d-flex gap-2">
    ...
    <button
      type="button"
      class="btn btn-excluir-todas"
      onclick="excluirTodasPendencias()"
    >
...
<div class="row g-3 mb-4">
  ...
  <div class="col-6 col-md-4 col-xl-2">
    <div
      class="ftx-stat-card filtro-ativo"
      data-filtro="total"
      onclick="filtrarPorCard('total')"
    >
  ...
  <div class="col-6 col-md-4 col-xl-2">
    <div
      class="ftx-stat-card"
      data-filtro="veiculo"
      onclick="filtrarPorCard('veiculo')"
    >
  ...
  <div class="col-6 col-md-4 col-xl-2">
    <div
      class="ftx-stat-card"
      data-filtro="motorista"
      onclick="filtrarPorCard('motorista')"
    >
  ...
  <div class="col-6 col-md-4 col-xl-2">
    <div
      class="ftx-stat-card"
      data-filtro="corrigivel"
      onclick="filtrarPorCard('corrigivel')"
    >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="sugestao-modal-body">
          ...
          <div
            class="sugestao-justificativa"
            id="txtSugestaoJustificativa"
          ></div>
        </div>
      </div>
      <div class="modal-footer">
        ...
        <button
          ...
          onclick="confirmarAplicarSugestao()"
        >
          <span class="btn-text"
            ><i class="fa-duotone fa-check"></i> Aplicar Correção</span
          >
          <span class="btn-loading d-none"
            ><i class="fa-duotone fa-spinner fa-spin"></i> Aplicando...</span
          >
        </button>
      </div>
    </div>
...
**Descrição**: Adição de documentação JSDoc completa nos scripts JavaScript embarcados.
...
- ✅ Documentadas 19 funções: mostrarLoading, esconderLoading, filtrarPorCard, aplicarFiltroDataTable, carregarEstatisticas, carregarPendencias, renderBadgePendencia, renderAcoes, aplicarSugestao, confirmarAplicarSugestao, executarAplicarSugestao, editarPendencia, aplicarSugestaoNoModal, salvarPendencia, salvarEImportar, resolverPendenciaAjax, excluirPendencia, excluirTodasPendencias, setButtonLoading
- ✅ Cada função possui @@description, @@param e @@returns
...
- Pages/Abastecimento/Pendencias.cshtml - Substituição de `btn-ftx-fechar` por `btn-vinho` em botão de modal
