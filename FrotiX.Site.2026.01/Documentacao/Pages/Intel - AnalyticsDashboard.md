# Documentação: Intel - AnalyticsDashboard
...
- **CSS** (7):
  ...
  - `~/css/profilecards.css`
  - `~/css/profilecommon.css`
- **JS** (2):
...
- ✅ Documentadas 2 funções: trimTransparentPNG, applyTrimToImg
