 ...
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║ ❓ POR QUE EXISTO?                                                       ║
 * ║    Gestão de Ordens de Serviço de Manutenção (Preventiva/Corretiva).     ║
 * ║    • CRUD completo de OS com DataTables                                  ║
 * ║    • Upload de fotos de itens/peças                                      ║
 * ║    • Gestão de ocorrências e pendências                                  ║
 * ║    • RichTextEditor Syncfusion para descrições                           ║
 * ║    • Fluxo de aprovação e fechamento de OS                               ║
 * ║                                                                          ║
 * ║ 🔗 RELEVÂNCIA: Crítica (Core - Manutenção de Frota)                      ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 */
    ...
    modalEl.addEventListener('show.bs.modal', function (event) {
        try {
            ...
            const elementosUpload = [
                '#txtFileItem',
                '#txtFileItemNovo', // Inputs de arquivo
                '#divUploadFoto',
                '#divControlesUpload', // Containers de upload
                '.upload-container',
                '.k-upload', // Kendo upload
                '#btnGravarFoto',
                '#btnSalvarFoto', // Botões de gravar
                '#lblSelecionarFoto',
                '#lblInstrucaoUpload', // Labels de instrução
            ];
