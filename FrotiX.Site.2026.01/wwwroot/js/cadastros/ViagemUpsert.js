 ...
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║ ❓ POR QUE EXISTO?                                                       ║
 * ║    Formulário de criação/edição de Viagens (Upsert).                     ║
 * ║    • Validação de formulário com máscaras                                ║
 * ║    • Integração com Syncfusion DateTimePicker                            ║
 * ║    • Upload de fotos (KM inicial/final, documentos)                      ║
 * ║    • Cálculo automático de custos e distâncias                           ║
 * ║    • Gestão de passageiros e destinos múltiplos                          ║
 * ║    • Overlay de loading FrotiX durante gravação                          ║
 * ║                                                                          ║
 * ║ 🔗 RELEVÂNCIA: Crítica (Core - Cadastro de Viagens)                      ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 */
