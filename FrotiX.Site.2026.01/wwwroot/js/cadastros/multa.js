 ...
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║ ❓ POR QUE EXISTO?                                                       ║
 * ║    Gestão de Multas de Trânsito - Ciclo completo.                         ║
 * ║    • Importação de multas via planilha                                   ║
 * ║    • Identificação de condutores                                         ║
 * ║    • Recursos e contestações                                              ║
 * ║    • Liquidação financeira e cobrança                                    ║
 * ║    • Dashboard com KPIs de infrações                                      ║
 * ║                                                                          ║
 * ║ 🔗 RELEVÂNCIA: Crítica (Core - Gestão de Multas)                         ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 */
