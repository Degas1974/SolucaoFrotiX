 ...
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║ ❓ POR QUE EXISTO?                                                       ║
 * ║    Sistema de Gestão de Alertas FrotiX (Central de Alertas).             ║
 * ║    • DataTable de alertas lidos                                         ║
 * ║    • SignalR para notificações real-time                                 ║
 * ║    • Sino de notificações na navbar                                      ║
 * ║                                                                          ║
 * ║ 🔗 RELEVÂNCIA: Crítica (Alertas - Central)                                ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 */
...
function inicializarDataTableMeusAlertas() {
    try {
        ...
        tabelaMeusAlertas = $('#tblMeusAlertas').DataTable({
            ...
            columnDefs: [{ orderable: false, targets: '_all' }],
            order: [[0, 'desc']], // Ordenar por data de criação (coluna oculta ou usar índice da coluna de título)
            language: {
                url: '//cdn.datatables.net/plug-ins/1.13.8/i18n/pt-BR.json',
            },
            pageLength: 25,
