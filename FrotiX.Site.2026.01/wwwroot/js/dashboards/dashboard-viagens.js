 ...
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║ ❓ POR QUE EXISTO?                                                       ║
 * ║    Dashboard analítico de Viagens e Operações.                            ║
 * ║    • KPIs de viagens realizadas, km e custos                            ║
 * ║    • Gráficos de evolução temporal                                       ║
 * ║    • Análise por setor, finalidade e destino                            ║
 * ║    • Exportação PDF profissional                                         ║
 * ║                                                                          ║
 * ║ 🔗 RELEVÂNCIA: Crítica (Dashboard Principal)                             ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 */
