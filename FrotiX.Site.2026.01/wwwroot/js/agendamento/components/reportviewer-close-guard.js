 ...
 * ║    • Intercepta tentativas de fechar modal durante loading               ║
 * ║    • Patch no plugin Telerik ReportViewer                                ║
 * ║    • Adia fechamento para após renderização completa                     ║
 * ║    • Flags globais: isReportViewerLoading, _pendingCloseAfterRender      ║
 * ║                                                                          ║
 * ║ 🔗 RELEVÂNCIA: Alta (Agenda - Report Guard)                              ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 */
