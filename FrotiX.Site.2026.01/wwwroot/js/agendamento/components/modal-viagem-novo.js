 ...
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║ ❓ POR QUE EXISTO?                                                       ║
 * ║    Modal de Agendamento de Viagem - Gerenciamento Completo.              ║
 * ║    • Criação de agendamentos                                             ║
 * ║    • Envio e comunicação com API                                         ║
 * ║    • Edição e Alteração de data inicial                                  ║
 * ║                                                                          ║
 * ║ 🔗 RELEVÂNCIA: Crítica (Agenda - Modal Principal)                         ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 * ESTRUTURA:
...
window.criarAgendamentoNovo = function () {
    try {
        ...
        )?.ej2_instances?.[0]; // Mantém Syncfusion
...
window.limparCamposModalViagens = function () {
    try {
        ...
        // Limpar campos de duração e quilometragem (Kendo NumericTextBox)
