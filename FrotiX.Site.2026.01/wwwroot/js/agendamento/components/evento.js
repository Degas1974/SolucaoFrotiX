 ...
 * ║    • Monitoramento de mudanças na finalidade                            ║
 * ║    • Integração com ExibeViagem                                          ║
 * ║    • Gestão de eventos de viagem                                        ║
 * ║                                                                          ║
 * ║ 🔗 RELEVÂNCIA: Alta (Agenda - Eventos)                                   ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 */
...
function limparCamposCadastroEvento() {
    try {
        ...
        // NumericTextBox Kendo (quantidade)
...
function inserirNovoEvento() {
    try {
        ...
        // Pega quantidade (Kendo NumericTextBox)
