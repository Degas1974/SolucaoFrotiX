 ...
 * ║ PageModel para Controle de Lavagem - gestão de lavagens de veículos da frota                         ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 * ║ @arquivo    ControleLavagem.cshtml.cs                                                                 ║
 * ║ @local      Pages/Manutencao/                                                                         ║
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia Controle de lavagens com registro de viagens e fichas de vistoria                        ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
using System;
