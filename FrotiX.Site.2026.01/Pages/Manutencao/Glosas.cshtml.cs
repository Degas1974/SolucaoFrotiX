 ...
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ Glosas.cshtml.cs                                                                                      ║
 * ║ PageModel para gestão de Glosas - controle de glosas contratuais de manutenção                       ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 * ║ @arquivo    Glosas.cshtml.cs                                                                          ║
 * ║ @local      Pages/Manutencao/                                                                         ║
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia Gerenciamento de glosas por contrato, mês e ano                                          ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
using System;
