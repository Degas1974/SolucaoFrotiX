 ...
 * ║ PageModel para PBI de Lavagem - relatório Power BI integrado de lavagens                             ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 * ║ @arquivo    PBILavagem.cshtml.cs                                                                      ║
 * ║ @local      Pages/Manutencao/                                                                         ║
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia Integração com Power BI para relatórios de lavagem e vistoria                            ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
using System;
