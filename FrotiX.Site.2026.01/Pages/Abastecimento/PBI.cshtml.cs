 ...
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ PBI.cshtml.cs                                                                                        ║
 * ║ PageModel para integração com Power BI e relatórios de Abastecimento                                 ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 * ║ @arquivo    PBI.cshtml.cs                                                                            ║
 * ║ @local      Pages/Abastecimento/                                                                     ║
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia Exportação e visualização de dados para Power BI                                         ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
...
namespace FrotiX.Pages.Viagens
{
    public class PBIModel : PageModel
    {
        ...
        )
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "PBIModel", error);
            }
        }
        ...
        public static void ConvertContentTo(HtmlNode node, TextWriter outText)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "ConvertContentTo", error);
                return; // padronizado
            }
        }
        ...
        public static string ConvertHtml(string html)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "ConvertHtml", error);
        ...
        public static void ConvertTo(HtmlNode node, TextWriter outText)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "ConvertTo", error);
                return; // padronizado
            }
        }
        ...
        public IActionResult OnGet(Guid id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "OnGet", error);
                return Page();
            }
        }
        ...
        public JsonResult OnGetPegaKmAtualVeiculo(string id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "OnGetPegaKmAtualVeiculo", error);
                return new JsonResult(new { sucesso = false }); // padronizado
            }
        }
        ...
        public JsonResult OnGetPegaRamal(string id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "OnGetPegaRamal", error);
                return new JsonResult(new { sucesso = false }); // padronizado
            }
        }
        ...
        public JsonResult OnGetPegaSetor(string id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "OnGetPegaSetor", error);
                return new JsonResult(new { sucesso = false }); // padronizado
            }
        }
        ...
        public JsonResult OnGetVerificaFicha(string id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "OnGetVerificaFicha", error);
                return new JsonResult(new { sucesso = false }); // padronizado
            }
        }
        ...
        public JsonResult OnGetVerificaVeiculoViagem(string id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "OnGetVerificaVeiculoViagem", error);
                return new JsonResult(new { sucesso = false }); // padronizado
            }
        }
        ...
        public IActionResult OnPostEdit(Guid Id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "OnPostEdit", error);
                return RedirectToPage("./Index");
            }
        }
        ...
        public IActionResult OnPostInsereFicha(Guid Id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "OnPostInsereFicha", error);
                return RedirectToPage("./Index");
            }
        }
        ...
        public IActionResult OnPostSubmit()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "OnPostSubmit", error);
                return RedirectToPage("./Index");
            }
        }
        ...
        public void PreencheListaCombustivel()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "PreencheListaCombustivel", error);
                return; // padronizado
            }
        }
        ...
        public void PreencheListaFinalidade()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "PreencheListaFinalidade", error);
                return; // padronizado
            }
        }
        ...
        public void PreencheListaMotoristas()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "PreencheListaMotoristas", error);
                return; // padronizado
            }
        }
        ...
        public void PreencheListaRequisitantes()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "PreencheListaRequisitantes", error);
                return; // padronizado
            }
        }
        ...
        public void PreencheListaSetores()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "PreencheListaSetores", error);
                return; // padronizado
            }
        }
        ...
        public void PreencheListaVeiculos()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "PreencheListaVeiculos", error);
                return; // padronizado
            }
        }
        ...
        private void SetViewModel()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBI.cshtml.cs", "SetViewModel", error);
                return; // padronizado
            }
        }
