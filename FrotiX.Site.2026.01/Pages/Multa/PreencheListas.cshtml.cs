 ...
 * ║ PageModel para preenchimento de listas de multas via handlers AJAX                                    ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 * ║ @arquivo    PreencheListas.cshtml.cs                                                                  ║
 * ║ @local      Pages/Multa/                                                                              ║
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia População dinâmica de listas e combos do módulo de multas                                 ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
