 ...
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ TaxiLeg.cshtml.cs                                                                                   ║
 * ║ PageModel para funcionalidade de TaxiLeg                                                            ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 * ║ @arquivo    TaxiLeg.cshtml.cs                                                                       ║
 * ║ @local      Pages/Viagens/                                                                                ║
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
...
namespace FrotiX.Pages.Viagens
{
    public class TaxiLegModel : PageModel
    {
        ...
        )
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "TaxiLegModel", error);
            }
        }
        ...
        public static void ConvertContentTo(HtmlNode node, TextWriter outText)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "ConvertContentTo", error);
                return; // padronizado
            }
        }
        ...
        public static string ConvertHtml(string html)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "ConvertHtml", error);
        ...
        public static void ConvertTo(HtmlNode node, TextWriter outText)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "ConvertTo", error);
                return; // padronizado
            }
        }
        ...
        public IActionResult OnGet(Guid id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "OnGet", error);
                return Page();
            }
        }
        ...
        public JsonResult OnGetPegaRamal(string id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "OnGetPegaRamal", error);
                return new JsonResult(new { sucesso = false }); // padronizado
            }
        }
        ...
        public JsonResult OnGetPegaSetor(string id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "OnGetPegaSetor", error);
                return new JsonResult(new { sucesso = false }); // padronizado
            }
        }
        ...
        public JsonResult OnGetVerificaFicha(string id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "OnGetVerificaFicha", error);
                return new JsonResult(new { sucesso = false }); // padronizado
            }
        }
        ...
        public IActionResult OnPostEdit(Guid Id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "OnPostEdit", error);
                return RedirectToPage("./Index");
            }
        }
        ...
        public IActionResult OnPostInsereFicha(Guid Id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "OnPostInsereFicha", error);
                return RedirectToPage("./Index");
            }
        }
        ...
        public IActionResult OnPostSubmit()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "OnPostSubmit", error);
                return RedirectToPage("./Index");
            }
        }
        ...
        public void PreencheListaSetores()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "PreencheListaSetores", error);
                return; // padronizado
            }
        }
        ...
        public void PreencheListaVeiculos()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "PreencheListaVeiculos", error);
                return; // padronizado
            }
        }
        ...
        private void SetViewModel()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("TaxiLeg.cshtml.cs", "SetViewModel", error);
                return; // padronizado
            }
        }
