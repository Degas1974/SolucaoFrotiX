 ...
 * ║  ╚═╝     ╚═╝  ╚═╝ ╚═════╝    ╚═╝   ╚═╝╚═╝  ╚═╝    ╚══════╝╚═╝   ╚═╝   ╚══════╝                        ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ PBITaxiLeg.cshtml.cs                                                                                ║
 * ║ PageModel para funcionalidade de PBITaxiLeg                                                         ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 * ║ @arquivo    PBITaxiLeg.cshtml.cs                                                                    ║
 * ║ @local      Pages/TaxiLeg/                                                                                ║
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia Integração TaxiLeg                                                                      ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
using System;
...
namespace FrotiX.Pages.Viagens
{
    public class PBITaxiLegModel : PageModel
    {
        ...
        )
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBITaxiLeg.cshtml.cs", "PBITaxiLegModel", error);
            }
        }
        ...
        public static void ConvertContentTo(HtmlNode node, TextWriter outText)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBITaxiLeg.cshtml.cs", "ConvertContentTo", error);
                return; // padronizado
            }
        }
        ...
        public static string ConvertHtml(string html)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBITaxiLeg.cshtml.cs", "ConvertHtml", error);
        ...
        public static void ConvertTo(HtmlNode node, TextWriter outText)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBITaxiLeg.cshtml.cs", "ConvertTo", error);
                return; // padronizado
            }
        }
        ...
        public IActionResult OnGet(Guid id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBITaxiLeg.cshtml.cs", "OnGet", error);
                return Page();
            }
        }
        ...
        public JsonResult OnGetPegaRamal(string id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBITaxiLeg.cshtml.cs", "OnGetPegaRamal", error);
                return new JsonResult(new { sucesso = false }); // padronizado
            }
        }
        ...
        public JsonResult OnGetPegaSetor(string id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBITaxiLeg.cshtml.cs", "OnGetPegaSetor", error);
                return new JsonResult(new { sucesso = false }); // padronizado
            }
        }
        ...
        public JsonResult OnGetVerificaFicha(string id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBITaxiLeg.cshtml.cs", "OnGetVerificaFicha", error);
                return new JsonResult(new { sucesso = false }); // padronizado
            }
        }
        ...
        public IActionResult OnPostEdit(Guid Id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBITaxiLeg.cshtml.cs", "OnPostEdit", error);
                return RedirectToPage("./Index");
            }
        }
        ...
        public IActionResult OnPostInsereFicha(Guid Id)
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBITaxiLeg.cshtml.cs", "OnPostInsereFicha", error);
                return RedirectToPage("./Index");
            }
        }
        ...
        public IActionResult OnPostSubmit()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBITaxiLeg.cshtml.cs", "OnPostSubmit", error);
                return RedirectToPage("./Index");
            }
        }
        ...
        private void SetViewModel()
        {
            ...
            {
                Alerta.TratamentoErroComLinha("PBITaxiLeg.cshtml.cs", "SetViewModel", error);
                return; // padronizado
            }
        }
