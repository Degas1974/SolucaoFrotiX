 ...
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ UploadCNH.cshtml.cs                                                                                   ║
 * ║ PageModel para Upload de CNH - envio e gestão de documentos de habilitação                           ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 * ║ @arquivo    UploadCNH.cshtml.cs                                                                       ║
 * ║ @local      Pages/Motorista/                                                                          ║
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia Upload e validação de CNH digital dos motoristas                                         ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
using FrotiX.Models;
