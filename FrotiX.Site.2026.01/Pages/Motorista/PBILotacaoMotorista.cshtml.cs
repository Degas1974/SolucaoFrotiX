 ...
 * ║ PageModel para PBI de Lotação de Motorista - relatório Power BI de alocação                          ║
 * ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
 * ║ METADATA                                                                                             ║
 * ║ @arquivo    PBILotacaoMotorista.cshtml.cs                                                             ║
 * ║ @local      Pages/Motorista/                                                                          ║
 * ║ @versao     1.0.0                                                                                    ║
 * ║ @data       23/01/2026                                                                               ║
 * ║ @relevancia Integração com Power BI para relatórios de lotação de motoristas                         ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
using System;
