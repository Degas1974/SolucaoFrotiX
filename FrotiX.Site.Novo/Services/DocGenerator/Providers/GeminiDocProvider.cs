/* ╔════════════════════════════════════════════════════════════════════════════════════════════════════╗
   ║ 🚀 ARQUIVO: GeminiDocProvider.cs                                                                    ║
   ║ 📂 CAMINHO: /Services/DocGenerator/Providers                                                        ║
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
   ║ 🎯 OBJETIVO: Provedor de IA usando Google Gemini generateContent API. Herda BaseDocProvider.        ║
   ╠════════════════════════════════════════════════════════════════════════════════════════════════════╣
   ║ 📋 ÍNDICE: GenerateAsync(), BuildRequest(), ParseResponse(), ProviderName, IsAvailable              ║
   ║ 🔗 DEPS: HttpClient, BaseDocProvider, IDocAiProvider | 📅 15/01/2026 | 👤 Copilot | 📝 v2.0         ║
   ╚════════════════════════════════════════════════════════════════════════════════════════════════════╝
*/
