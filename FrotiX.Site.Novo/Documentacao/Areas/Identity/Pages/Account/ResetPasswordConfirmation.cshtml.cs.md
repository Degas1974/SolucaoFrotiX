# ResetPasswordConfirmation.cshtml.cs — PageModel de confirmação

> **Arquivo:** `Areas/Identity/Pages/Account/ResetPasswordConfirmation.cshtml.cs`  
> **Papel:** manter a página de confirmação sem lógica extra.

---

## ✅ Visão Geral

`OnGet` vazio, apenas para renderização.
