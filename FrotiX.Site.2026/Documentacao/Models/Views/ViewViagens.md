...
## [12/01/2026 22:23] - Correção de Warning CS8618

**Descrição**: Corrigido warning de compilação CS8618 em propriedade NotMapped

**Mudanças**:
- Adicionado `= null!` na propriedade `FotoUpload` (linha 85)

**Arquivos Afetados**:
- `Models/Views/ViewViagens.cs` (linha 85)
