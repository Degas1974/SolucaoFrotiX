...
-- Script date 07/02/2026 22:43:45
-- Server version: 16.00.1165
--
...
--
-- Create index [IX_WhatsAppMensagens_ContatoId] on table [dbo].[WhatsAppMensagens]
--
PRINT (N'Create index [IX_WhatsAppMensagens_ContatoId] on table [dbo].[WhatsAppMensagens]')
GO
...
--
-- Create index [IX_WhatsAppMensagens_InstanciaId] on table [dbo].[WhatsAppMensagens]
--
PRINT (N'Create index [IX_WhatsAppMensagens_InstanciaId] on table [dbo].[WhatsAppMensagens]')
GO
...
--
-- Create index [IX_WhatsAppMensagens_UsuarioId] on table [dbo].[WhatsAppMensagens]
--
PRINT (N'Create index [IX_WhatsAppMensagens_UsuarioId] on table [dbo].[WhatsAppMensagens]')
GO
...
--
-- Create foreign key [FK_WhatsAppMensagens_ContatoId] on table [dbo].[WhatsAppMensagens]
--
PRINT (N'Create foreign key [FK_WhatsAppMensagens_ContatoId] on table [dbo].[WhatsAppMensagens]')
GO
ALTER TABLE dbo.WhatsAppMensagens WITH NOCHECK
  ADD CONSTRAINT FK_WhatsAppMensagens_ContatoId FOREIGN KEY (ContatoId) REFERENCES dbo.WhatsAppContatos (Id)
GO

--
-- Create foreign key [FK_WhatsAppMensagens_InstanciaId] on table [dbo].[WhatsAppMensagens]
--
PRINT (N'Create foreign key [FK_WhatsAppMensagens_InstanciaId] on table [dbo].[WhatsAppMensagens]')
GO
ALTER TABLE dbo.WhatsAppMensagens WITH NOCHECK
  ADD CONSTRAINT FK_WhatsAppMensagens_InstanciaId FOREIGN KEY (InstanciaId) REFERENCES dbo.WhatsAppInstancias (Id)
GO
...
--
-- Create index [IX_WhatsAppFilaMensagens_MensagemId] on table [dbo].[WhatsAppFilaMensagens]
--
PRINT (N'Create index [IX_WhatsAppFilaMensagens_MensagemId] on table [dbo].[WhatsAppFilaMensagens]')
GO
...
--
-- Create foreign key [FK_WhatsAppFilaMensagens_MensagemId] on table [dbo].[WhatsAppFilaMensagens]
--
PRINT (N'Create foreign key [FK_WhatsAppFilaMensagens_MensagemId] on table [dbo].[WhatsAppFilaMensagens]')
GO
ALTER TABLE dbo.WhatsAppFilaMensagens WITH NOCHECK
  ADD CONSTRAINT FK_WhatsAppFilaMensagens_MensagemId FOREIGN KEY (MensagemId) REFERENCES dbo.WhatsAppMensagens (Id)
GO
...
--
-- Create index [IX_SetorSolicitante_SetorPaiId] on table [dbo].[SetorSolicitante]
--
PRINT (N'Create index [IX_SetorSolicitante_SetorPaiId] on table [dbo].[SetorSolicitante]')
GO
...
--
-- Create foreign key [FK_SetorSolicitante_SetorPaiId] on table [dbo].[SetorSolicitante]
--
PRINT (N'Create foreign key [FK_SetorSolicitante_SetorPaiId] on table [dbo].[SetorSolicitante]')
GO
ALTER TABLE dbo.SetorSolicitante WITH NOCHECK
  ADD CONSTRAINT FK_SetorSolicitante_SetorPaiId FOREIGN KEY (SetorPaiId) REFERENCES dbo.SetorSolicitante (SetorSolicitanteId)
GO
...
--
-- Add extended property [MS_Description] on table [dbo].[LogErros]
--
PRINT (N'Add extended property [MS_Description] on table [dbo].[LogErros]')
GO
EXEC sys.sp_addextendedproperty N'MS_Description', N'Tabela de logs de erros do sistema FrotiX (servidor e cliente). Armazena todos os erros, warnings e informações para análise e dashboard.', 'SCHEMA', N'dbo', 'TABLE', N'LogErros'
GO

--
-- Add extended property [MS_Description] on column [dbo].[LogErros].[Tipo]
--
PRINT (N'Add extended property [MS_Description] on column [dbo].[LogErros].[Tipo]')
GO
EXEC sys.sp_addextendedproperty N'MS_Description', N'Tipo do log: ERROR, WARN, INFO, ERROR-JS, CONSOLE-INFO, CONSOLE-ERROR, HTTP-ERROR, etc.', 'SCHEMA', N'dbo', 'TABLE', N'LogErros', 'COLUMN', N'Tipo'
GO

--
-- Add extended property [MS_Description] on column [dbo].[LogErros].[Origem]
--
PRINT (N'Add extended property [MS_Description] on column [dbo].[LogErros].[Origem]')
GO
EXEC sys.sp_addextendedproperty N'MS_Description', N'Origem do log: SERVER (C#/ASP.NET) ou CLIENT (JavaScript/Console)', 'SCHEMA', N'dbo', 'TABLE', N'LogErros', 'COLUMN', N'Origem'
GO
...
--
-- Create foreign key [FK_RepactuacaoServicos_RepactuacaoContratoId] on table [dbo].[RepactuacaoServicos]
--
PRINT (N'Create foreign key [FK_RepactuacaoServicos_RepactuacaoContratoId] on table [dbo].[RepactuacaoServicos]')
GO
ALTER TABLE dbo.RepactuacaoServicos WITH NOCHECK
  ADD CONSTRAINT FK_RepactuacaoServicos_RepactuacaoContratoId FOREIGN KEY (RepactuacaoContratoId) REFERENCES dbo.RepactuacaoContrato (RepactuacaoContratoId)
GO
...
--
-- Create foreign key [FK_Lavador_ContratoId] on table [dbo].[Lavador]
--
PRINT (N'Create foreign key [FK_Lavador_ContratoId] on table [dbo].[Lavador]')
GO
ALTER TABLE dbo.Lavador WITH NOCHECK
  ADD CONSTRAINT FK_Lavador_ContratoId FOREIGN KEY (ContratoId) REFERENCES dbo.Contrato (ContratoId)
GO
...
--
-- Create index [IX_DocumentoContrato_ContratoId] on table [dbo].[DocumentoContrato]
--
PRINT (N'Create index [IX_DocumentoContrato_ContratoId] on table [dbo].[DocumentoContrato]')
GO
CREATE INDEX IX_DocumentoContrato_ContratoId
...
--
-- Create foreign key [FK_DocumentoContrato_ContratoId] on table [dbo].[DocumentoContrato]
--
PRINT (N'Create foreign key [FK_DocumentoContrato_ContratoId] on table [dbo].[DocumentoContrato]')
GO
ALTER TABLE dbo.DocumentoContrato WITH NOCHECK
  ADD CONSTRAINT FK_DocumentoContrato_ContratoId FOREIGN KEY (ContratoId) REFERENCES dbo.Contrato (ContratoId)
GO
...
GO
ALTER TABLE dbo.AtaRegistroPrecos WITH NOCHECK
...
--
-- Create index [IX_ItemVeiculoAta_RepactuacaoAtaId] on table [dbo].[ItemVeiculoAta]
--
PRINT (N'Create index [IX_ItemVeiculoAta_RepactuacaoAtaId] on table [dbo].[ItemVeiculoAta]')
GO
...
--
-- Create foreign key [FK_ItemVeiculoAta_RepactuacaoAtaId] on table [dbo].[ItemVeiculoAta]
--
PRINT (N'Create foreign key [FK_ItemVeiculoAta_RepactuacaoAtaId] on table [dbo].[ItemVeiculoAta]')
GO
ALTER TABLE dbo.ItemVeiculoAta WITH NOCHECK
  ADD CONSTRAINT FK_ItemVeiculoAta_RepactuacaoAtaId FOREIGN KEY (RepactuacaoAtaId) REFERENCES dbo.RepactuacaoAta (RepactuacaoAtaId)
GO
...
--
-- Create index [IX_CorridasTaxiLeg_DataAgenda] on table [dbo].[CorridasTaxiLeg]
--
PRINT (N'Create index [IX_CorridasTaxiLeg_DataAgenda] on table [dbo].[CorridasTaxiLeg]')
GO
CREATE INDEX IX_CorridasTaxiLeg_DataAgenda
...
--
-- Create index [IX_CorridasCanceladasTaxiLeg_DataAgenda] on table [dbo].[CorridasCanceladasTaxiLeg]
--
PRINT (N'Create index [IX_CorridasCanceladasTaxiLeg_DataAgenda] on table [dbo].[CorridasCanceladasTaxiLeg]')
GO
CREATE INDEX IX_CorridasCanceladasTaxiLeg_DataAgenda
...
--
-- Create index [IX_Contatos_Nome] on table [dbo].[Contatos]
--
PRINT (N'Create index [IX_Contatos_Nome] on table [dbo].[Contatos]')
GO
...
--
-- Create index [IX_Veiculo_AtaId] on table [dbo].[Veiculo]
--
PRINT (N'Create index [IX_Veiculo_AtaId] on table [dbo].[Veiculo]')
GO
...
--
-- Create index [IX_Veiculo_CombustivelId] on table [dbo].[Veiculo]
--
PRINT (N'Create index [IX_Veiculo_CombustivelId] on table [dbo].[Veiculo]')
GO
...
--
-- Create foreign key [FK_Veiculo_AtaId] on table [dbo].[Veiculo]
--
PRINT (N'Create foreign key [FK_Veiculo_AtaId] on table [dbo].[Veiculo]')
GO
ALTER TABLE dbo.Veiculo WITH NOCHECK
  ADD CONSTRAINT FK_Veiculo_AtaId FOREIGN KEY (AtaId) REFERENCES dbo.AtaRegistroPrecos (AtaId)
GO

--
-- Create foreign key [FK_Veiculo_CombustivelId] on table [dbo].[Veiculo]
--
PRINT (N'Create foreign key [FK_Veiculo_CombustivelId] on table [dbo].[Veiculo]')
GO
ALTER TABLE dbo.Veiculo WITH NOCHECK
  ADD CONSTRAINT FK_Veiculo_CombustivelId FOREIGN KEY (CombustivelId) REFERENCES dbo.Combustivel (CombustivelId)
GO

--
-- Create foreign key [FK_Veiculo_ContratoId] on table [dbo].[Veiculo]
--
PRINT (N'Create foreign key [FK_Veiculo_ContratoId] on table [dbo].[Veiculo]')
GO
ALTER TABLE dbo.Veiculo WITH NOCHECK
  ADD CONSTRAINT FK_Veiculo_ContratoId FOREIGN KEY (ContratoId) REFERENCES dbo.Contrato (ContratoId)
GO
...
--
-- Create index [IX_NotaFiscal_ContratoId_AnoMes] on table [dbo].[NotaFiscal]
--
PRINT (N'Create index [IX_NotaFiscal_ContratoId_AnoMes] on table [dbo].[NotaFiscal]')
GO
CREATE INDEX IX_NotaFiscal_ContratoId_AnoMes
...
--
-- Create index [IX_NotaFiscal_EmpenhoId] on table [dbo].[NotaFiscal]
--
PRINT (N'Create index [IX_NotaFiscal_EmpenhoId] on table [dbo].[NotaFiscal]')
GO
CREATE INDEX IX_NotaFiscal_EmpenhoId
...
--
-- Create index [IX_NotaFiscal_VeiculoId] on table [dbo].[NotaFiscal]
--
PRINT (N'Create index [IX_NotaFiscal_VeiculoId] on table [dbo].[NotaFiscal]')
GO
...
--
-- Create foreign key [FK_NotaFiscal_VeiculoId] on table [dbo].[NotaFiscal]
--
PRINT (N'Create foreign key [FK_NotaFiscal_VeiculoId] on table [dbo].[NotaFiscal]')
GO
ALTER TABLE dbo.NotaFiscal WITH NOCHECK
  ADD CONSTRAINT FK_NotaFiscal_VeiculoId FOREIGN KEY (VeiculoId) REFERENCES dbo.Veiculo (VeiculoId)
GO
...
--
-- Create index [IX_Patrimonio_SecaoConferenciaId] on table [dbo].[Patrimonio]
--
PRINT (N'Create index [IX_Patrimonio_SecaoConferenciaId] on table [dbo].[Patrimonio]')
GO
...
--
-- Create index [IX_Patrimonio_SetorConferenciaId] on table [dbo].[Patrimonio]
--
PRINT (N'Create index [IX_Patrimonio_SetorConferenciaId] on table [dbo].[Patrimonio]')
GO
...
--
-- Create foreign key [FK_Patrimonio_SecaoConferenciaId] on table [dbo].[Patrimonio]
--
PRINT (N'Create foreign key [FK_Patrimonio_SecaoConferenciaId] on table [dbo].[Patrimonio]')
GO
ALTER TABLE dbo.Patrimonio WITH NOCHECK
  ADD CONSTRAINT FK_Patrimonio_SecaoConferenciaId FOREIGN KEY (SecaoConferenciaId) REFERENCES dbo.SecaoPatrimonial (SecaoId)
GO
...
--
-- Create foreign key [FK_Patrimonio_SetorConferenciaId] on table [dbo].[Patrimonio]
--
PRINT (N'Create foreign key [FK_Patrimonio_SetorConferenciaId] on table [dbo].[Patrimonio]')
GO
ALTER TABLE dbo.Patrimonio WITH NOCHECK
  ADD CONSTRAINT FK_Patrimonio_SetorConferenciaId FOREIGN KEY (SetorConferenciaId) REFERENCES dbo.SetorPatrimonial (SetorId)
GO
...
--
-- Create index [IX_Manutencao_VeiculoReservaId] on table [dbo].[Manutencao]
--
PRINT (N'Create index [IX_Manutencao_VeiculoReservaId] on table [dbo].[Manutencao]')
GO
...
--
-- Create foreign key [FK_Manutencao_IdUsuarioCancelamento] on table [dbo].[Manutencao]
--
PRINT (N'Create foreign key [FK_Manutencao_IdUsuarioCancelamento] on table [dbo].[Manutencao]')
GO
ALTER TABLE dbo.Manutencao WITH NOCHECK
  ADD CONSTRAINT FK_Manutencao_IdUsuarioCancelamento FOREIGN KEY (IdUsuarioCancelamento) REFERENCES dbo.AspNetUsers (Id)
GO

--
-- Create foreign key [FK_Manutencao_IdUsuarioCriacao] on table [dbo].[Manutencao]
--
PRINT (N'Create foreign key [FK_Manutencao_IdUsuarioCriacao] on table [dbo].[Manutencao]')
GO
ALTER TABLE dbo.Manutencao WITH NOCHECK
  ADD CONSTRAINT FK_Manutencao_IdUsuarioCriacao FOREIGN KEY (IdUsuarioCriacao) REFERENCES dbo.AspNetUsers (Id)
GO

--
-- Create foreign key [FK_Manutencao_IdUsuarioFinalizacao] on table [dbo].[Manutencao]
--
PRINT (N'Create foreign key [FK_Manutencao_IdUsuarioFinalizacao] on table [dbo].[Manutencao]')
GO
ALTER TABLE dbo.Manutencao WITH NOCHECK
  ADD CONSTRAINT FK_Manutencao_IdUsuarioFinalizacao FOREIGN KEY (IdUsuarioFinalizacao) REFERENCES dbo.AspNetUsers (Id)
GO
...
--
-- Create index [IX_Motorista_UnidadeId] on table [dbo].[Motorista]
--
PRINT (N'Create index [IX_Motorista_UnidadeId] on table [dbo].[Motorista]')
GO
...
--
-- Create foreign key [FK_Motorista_CondutorId] on table [dbo].[Motorista]
--
PRINT (N'Create foreign key [FK_Motorista_CondutorId] on table [dbo].[Motorista]')
GO
ALTER TABLE dbo.Motorista WITH NOCHECK
  ADD CONSTRAINT FK_Motorista_CondutorId FOREIGN KEY (CondutorId) REFERENCES dbo.CondutorApoio (CondutorId)
GO

--
-- Create foreign key [FK_Motorista_ContratoId] on table [dbo].[Motorista]
--
PRINT (N'Create foreign key [FK_Motorista_ContratoId] on table [dbo].[Motorista]')
GO
ALTER TABLE dbo.Motorista WITH NOCHECK
  ADD CONSTRAINT FK_Motorista_ContratoId FOREIGN KEY (ContratoId) REFERENCES dbo.Contrato (ContratoId)
GO

--
-- Create foreign key [FK_Motorista_UnidadeId] on table [dbo].[Motorista]
--
PRINT (N'Create foreign key [FK_Motorista_UnidadeId] on table [dbo].[Motorista]')
GO
ALTER TABLE dbo.Motorista WITH NOCHECK
  ADD CONSTRAINT FK_Motorista_UnidadeId FOREIGN KEY (UnidadeId) REFERENCES dbo.Unidade (UnidadeId)
GO
...
--
-- Create index [IX_LotacaoMotorista_MotoristaCoberturaId] on table [dbo].[LotacaoMotorista]
--
PRINT (N'Create index [IX_LotacaoMotorista_MotoristaCoberturaId] on table [dbo].[LotacaoMotorista]')
GO
...
--
-- Create foreign key [FK_LotacaoMotorista_MotoristaCoberturaId] on table [dbo].[LotacaoMotorista]
--
PRINT (N'Create foreign key [FK_LotacaoMotorista_MotoristaCoberturaId] on table [dbo].[LotacaoMotorista]')
GO
ALTER TABLE dbo.LotacaoMotorista WITH NOCHECK
  ADD CONSTRAINT FK_LotacaoMotorista_MotoristaCoberturaId FOREIGN KEY (MotoristaCoberturaId) REFERENCES dbo.Motorista (MotoristaId)
GO
...
--
-- Create index [IX_ItensManutencao_MotoristaId] on table [dbo].[ItensManutencao]
--
PRINT (N'Create index [IX_ItensManutencao_MotoristaId] on table [dbo].[ItensManutencao]')
GO
...
--
-- Create foreign key [FK_ItensManutencao_MotoristaId] on table [dbo].[ItensManutencao]
--
PRINT (N'Create foreign key [FK_ItensManutencao_MotoristaId] on table [dbo].[ItensManutencao]')
GO
ALTER TABLE dbo.ItensManutencao WITH NOCHECK
  ADD CONSTRAINT FK_ItensManutencao_MotoristaId FOREIGN KEY (MotoristaId) REFERENCES dbo.Motorista (MotoristaId)
GO
...
--
-- Create index [IX_Multa_ContratoMotoristaId] on table [dbo].[Multa]
--
PRINT (N'Create index [IX_Multa_ContratoMotoristaId] on table [dbo].[Multa]')
GO
CREATE INDEX IX_Multa_ContratoMotoristaId
  ON dbo.Multa (ContratoMotoristaId)
  INCLUDE (Data, ValorAteVencimento)
  ON [PRIMARY]
GO

--
-- Create index [IX_Multa_ContratoVeiculoId] on table [dbo].[Multa]
--
PRINT (N'Create index [IX_Multa_ContratoVeiculoId] on table [dbo].[Multa]')
GO
...
--
-- Create index [IX_Multa_EmpenhoMultaId] on table [dbo].[Multa]
--
PRINT (N'Create index [IX_Multa_EmpenhoMultaId] on table [dbo].[Multa]')
GO
...
--
GO
PRINT (N'Create or alter procedure [dbo].[sp_RecalcularEstatisticasMultasMotoristas]')
GO
...
--
-- Create index [IX_MovimentacaoEmpenhoMulta_EmpenhoMultaId] on table [dbo].[MovimentacaoEmpenhoMulta]
--
PRINT (N'Create index [IX_MovimentacaoEmpenhoMulta_EmpenhoMultaId] on table [dbo].[MovimentacaoEmpenhoMulta]')
GO
CREATE INDEX IX_MovimentacaoEmpenhoMulta_EmpenhoMultaId
...
--
-- Create index [IX_MovimentacaoEmpenhoMulta_MultaId] on table [dbo].[MovimentacaoEmpenhoMulta]
--
PRINT (N'Create index [IX_MovimentacaoEmpenhoMulta_MultaId] on table [dbo].[MovimentacaoEmpenhoMulta]')
GO
CREATE INDEX IX_MovimentacaoEmpenhoMulta_MultaId
...
--
-- Create foreign key [FK_MovimentacaoEmpenhoMulta_EmpenhoMultaId] on table [dbo].[MovimentacaoEmpenhoMulta]
--
PRINT (N'Create foreign key [FK_MovimentacaoEmpenhoMulta_EmpenhoMultaId] on table [dbo].[MovimentacaoEmpenhoMulta]')
GO
ALTER TABLE dbo.MovimentacaoEmpenhoMulta WITH NOCHECK
  ADD CONSTRAINT FK_MovimentacaoEmpenhoMulta_EmpenhoMultaId FOREIGN KEY (EmpenhoMultaId) REFERENCES dbo.EmpenhoMulta (EmpenhoMultaId)
GO

--
-- Create foreign key [FK_MovimentacaoEmpenhoMulta_MultaId] on table [dbo].[MovimentacaoEmpenhoMulta]
--
PRINT (N'Create foreign key [FK_MovimentacaoEmpenhoMulta_MultaId] on table [dbo].[MovimentacaoEmpenhoMulta]')
GO
ALTER TABLE dbo.MovimentacaoEmpenhoMulta WITH NOCHECK
  ADD CONSTRAINT FK_MovimentacaoEmpenhoMulta_MultaId FOREIGN KEY (MultaId) REFERENCES dbo.Multa (MultaId)
GO
...
--
-- Create index [IX_Abastecimento_DataHora_Cobertura] on table [dbo].[Abastecimento]
--
PRINT (N'Create index [IX_Abastecimento_DataHora_Cobertura] on table [dbo].[Abastecimento]')
GO
CREATE INDEX IX_Abastecimento_DataHora_Cobertura
...
--
-- Create index [IX_Abastecimento_MotoristaId_DataHora] on table [dbo].[Abastecimento]
--
PRINT (N'Create index [IX_Abastecimento_MotoristaId_DataHora] on table [dbo].[Abastecimento]')
GO
CREATE INDEX IX_Abastecimento_MotoristaId_DataHora
...
--
-- Create foreign key [FK_Viagem_UsuarioIdCriacao] on table [dbo].[Viagem]
--
PRINT (N'Create foreign key [FK_Viagem_UsuarioIdCriacao] on table [dbo].[Viagem]')
GO
ALTER TABLE dbo.Viagem WITH NOCHECK
  ADD CONSTRAINT FK_Viagem_UsuarioIdCriacao FOREIGN KEY (UsuarioIdCriacao) REFERENCES dbo.AspNetUsers (Id)
GO
...
--
-- Create foreign key [FK_ItensManutencao_ViagemId] on table [dbo].[ItensManutencao]
--
PRINT (N'Create foreign key [FK_ItensManutencao_ViagemId] on table [dbo].[ItensManutencao]')
GO
ALTER TABLE dbo.ItensManutencao WITH NOCHECK
  ADD CONSTRAINT FK_ItensManutencao_ViagemId FOREIGN KEY (ViagemId) REFERENCES dbo.Viagem (ViagemId)
GO
...
CREATE OR ALTER VIEW dbo.ViewViagensAgenda AS
SELECT
...
--
-- Create table [dbo].[MotoristaItensPendentes]
--
PRINT (N'Create table [dbo].[MotoristaItensPendentes]')
GO
CREATE TABLE dbo.MotoristaItensPendentes (
  MotoristaItemId uniqueidentifier NOT NULL DEFAULT (newid()),
  MotoristaId uniqueidentifier NOT NULL,
  ViagemId uniqueidentifier NOT NULL,
  NoFichaVistoria int NULL,
  StatusCartaoAbastecimento bit NOT NULL DEFAULT (0),
  StatusDocumento bit NOT NULL DEFAULT (0),
  CintaDevolvida bit NOT NULL DEFAULT (0),
  TabletDevolvido bit NOT NULL DEFAULT (0),
  CaboDevolvido bit NOT NULL DEFAULT (0),
  ArlaDevolvido bit NOT NULL DEFAULT (0),
  DataCriacao datetime2 NOT NULL DEFAULT (getdate()),
  DataResolucao datetime2 NULL,
  Resolvido bit NOT NULL DEFAULT (0),
  UsuarioIdResolucao nvarchar(450) NULL,
  Observacao nvarchar(500) NULL,
  CONSTRAINT PK_MotoristaItensPendentes PRIMARY KEY CLUSTERED (MotoristaItemId)
)
ON [PRIMARY]
GO

--
-- Create index [IX_MotoristaItensPendentes_DataCriacao] on table [dbo].[MotoristaItensPendentes]
--
PRINT (N'Create index [IX_MotoristaItensPendentes_DataCriacao] on table [dbo].[MotoristaItensPendentes]')
GO
CREATE INDEX IX_MotoristaItensPendentes_DataCriacao
  ON dbo.MotoristaItensPendentes (DataCriacao DESC)
  ON [PRIMARY]
GO

--
-- Create index [IX_MotoristaItensPendentes_MotoristaId] on table [dbo].[MotoristaItensPendentes]
--
PRINT (N'Create index [IX_MotoristaItensPendentes_MotoristaId] on table [dbo].[MotoristaItensPendentes]')
GO
CREATE INDEX IX_MotoristaItensPendentes_MotoristaId
  ON dbo.MotoristaItensPendentes (MotoristaId)
  INCLUDE (ViagemId, Resolvido)
  ON [PRIMARY]
GO

--
-- Create index [IX_MotoristaItensPendentes_Resolvido] on table [dbo].[MotoristaItensPendentes]
--
PRINT (N'Create index [IX_MotoristaItensPendentes_Resolvido] on table [dbo].[MotoristaItensPendentes]')
GO
CREATE INDEX IX_MotoristaItensPendentes_Resolvido
  ON dbo.MotoristaItensPendentes (Resolvido)
  WHERE ([Resolvido]=(0))
  ON [PRIMARY]
GO

--
-- Create index [IX_MotoristaItensPendentes_ViagemId] on table [dbo].[MotoristaItensPendentes]
--
PRINT (N'Create index [IX_MotoristaItensPendentes_ViagemId] on table [dbo].[MotoristaItensPendentes]')
GO
CREATE INDEX IX_MotoristaItensPendentes_ViagemId
  ON dbo.MotoristaItensPendentes (ViagemId)
  ON [PRIMARY]
GO

--
-- Create foreign key [FK_MotoristaItensPendentes_MotoristaId] on table [dbo].[MotoristaItensPendentes]
--
PRINT (N'Create foreign key [FK_MotoristaItensPendentes_MotoristaId] on table [dbo].[MotoristaItensPendentes]')
GO
ALTER TABLE dbo.MotoristaItensPendentes WITH NOCHECK
  ADD CONSTRAINT FK_MotoristaItensPendentes_MotoristaId FOREIGN KEY (MotoristaId) REFERENCES dbo.Motorista (MotoristaId)
GO

--
-- Create foreign key [FK_MotoristaItensPendentes_UsuarioIdResolucao] on table [dbo].[MotoristaItensPendentes]
--
PRINT (N'Create foreign key [FK_MotoristaItensPendentes_UsuarioIdResolucao] on table [dbo].[MotoristaItensPendentes]')
GO
ALTER TABLE dbo.MotoristaItensPendentes WITH NOCHECK
  ADD CONSTRAINT FK_MotoristaItensPendentes_UsuarioIdResolucao FOREIGN KEY (UsuarioIdResolucao) REFERENCES dbo.AspNetUsers (Id)
GO

--
-- Create foreign key [FK_MotoristaItensPendentes_ViagemId] on table [dbo].[MotoristaItensPendentes]
--
PRINT (N'Create foreign key [FK_MotoristaItensPendentes_ViagemId] on table [dbo].[MotoristaItensPendentes]')
GO
ALTER TABLE dbo.MotoristaItensPendentes WITH NOCHECK
  ADD CONSTRAINT FK_MotoristaItensPendentes_ViagemId FOREIGN KEY (ViagemId) REFERENCES dbo.Viagem (ViagemId)
GO
...
--
-- Create foreign key [FK_AlertasFrotiX_UsuarioCriadorId] on table [dbo].[AlertasFrotiX]
--
PRINT (N'Create foreign key [FK_AlertasFrotiX_UsuarioCriadorId] on table [dbo].[AlertasFrotiX]')
GO
ALTER TABLE dbo.AlertasFrotiX WITH NOCHECK
  ADD CONSTRAINT FK_AlertasFrotiX_UsuarioCriadorId FOREIGN KEY (UsuarioCriadorId) REFERENCES dbo.AspNetUsers (Id)
GO
...
--
-- Create schema [DocGenerator]
--
PRINT (N'Create schema [DocGenerator]')
GO
CREATE SCHEMA DocGenerator AUTHORIZATION dbo
GO

--
-- Create table [DocGenerator].[MonitoringConfig]
--
PRINT (N'Create table [DocGenerator].[MonitoringConfig]')
GO
CREATE TABLE DocGenerator.MonitoringConfig (
  Id int IDENTITY,
...
--
PRINT (N'Create table [DocGenerator].[FileTracking]')
GO
CREATE TABLE DocGenerator.FileTracking (
  Id int IDENTITY,
...
--
-- Create index [IX_DocGen_FileTracking_LastModified] on table [DocGenerator].[FileTracking]
--
PRINT (N'Create index [IX_DocGen_FileTracking_LastModified] on table [DocGenerator].[FileTracking]')
GO
...
--
-- Create index [IX_DocGen_FileTracking_NeedsUpdate] on table [DocGenerator].[FileTracking]
--
PRINT (N'Create index [IX_DocGen_FileTracking_NeedsUpdate] on table [DocGenerator].[FileTracking]')
GO
CREATE INDEX IX_DocGen_FileTracking_NeedsUpdate
  ON DocGenerator.FileTracking (NeedsUpdate)
  ON [PRIMARY]
GO
...
--
PRINT (N'Create table [DocGenerator].[FileChangeHistory]')
GO
CREATE TABLE DocGenerator.FileChangeHistory (
  Id int IDENTITY,
  FilePath nvarchar(500) NOT NULL,
  ...
  DetectedAt datetime2 NULL DEFAULT (getdate()),
  PRIMARY KEY CLUSTERED (Id)
)
ON [PRIMARY]
GO
...
--
-- Create index [IX_DocGen_DetectedAt] on table [DocGenerator].[FileChangeHistory]
--
PRINT (N'Create index [IX_DocGen_DetectedAt] on table [DocGenerator].[FileChangeHistory]')
GO
CREATE INDEX IX_DocGen_DetectedAt
  ON DocGenerator.FileChangeHistory (DetectedAt)
  ON [PRIMARY]
GO

--
-- Create index [IX_DocGen_FileChangeHistory_FilePath_DetectedAt] on table [DocGenerator].[FileChangeHistory]
--
PRINT (N'Create index [IX_DocGen_FileChangeHistory_FilePath_DetectedAt] on table [DocGenerator].[FileChangeHistory]')
GO
CREATE INDEX IX_DocGen_FileChangeHistory_FilePath_DetectedAt
  ON DocGenerator.FileChangeHistory (FilePath, DetectedAt DESC)
  ON [PRIMARY]
GO

--
-- Create index [IX_DocGen_FilePath] on table [DocGenerator].[FileChangeHistory]
--
PRINT (N'Create index [IX_DocGen_FilePath] on table [DocGenerator].[FileChangeHistory]')
GO
CREATE INDEX IX_DocGen_FilePath
  ON DocGenerator.FileChangeHistory (FilePath)
  ON [PRIMARY]
GO
...
--
PRINT (N'Create table [DocGenerator].[DocumentationAlerts]')
GO
CREATE TABLE DocGenerator.DocumentationAlerts (
  Id int IDENTITY,
  FilePath nvarchar(500) NOT NULL,
...
--
-- Create index [IX_DocGen_Alert_FilePath] on table [DocGenerator].[DocumentationAlerts]
--
PRINT (N'Create index [IX_DocGen_Alert_FilePath] on table [DocGenerator].[DocumentationAlerts]')
GO
CREATE INDEX IX_DocGen_Alert_FilePath
  ON DocGenerator.DocumentationAlerts (FilePath)
  ON [PRIMARY]
GO

--
-- Create index [IX_DocGen_Alert_Priority] on table [DocGenerator].[DocumentationAlerts]
--
PRINT (N'Create index [IX_DocGen_Alert_Priority] on table [DocGenerator].[DocumentationAlerts]')
GO
CREATE INDEX IX_DocGen_Alert_Priority
  ON DocGenerator.DocumentationAlerts (Priority)
  ON [PRIMARY]
GO

--
-- Create index [IX_DocGen_Alert_Status] on table [DocGenerator].[DocumentationAlerts]
--
PRINT (N'Create index [IX_DocGen_Alert_Status] on table [DocGenerator].[DocumentationAlerts]')
GO
CREATE INDEX IX_DocGen_Alert_Status
  ON DocGenerator.DocumentationAlerts (Status)
  ON [PRIMARY]
GO

--
-- Create or alter procedure [DocGenerator].[sp_RunAutoScan]
--
GO
PRINT (N'Create or alter procedure [DocGenerator].[sp_RunAutoScan]')
GO
...
--
-- Create or alter procedure [DocGenerator].[sp_MarkAsDocumented]
--
GO
PRINT (N'Create or alter procedure [DocGenerator].[sp_MarkAsDocumented]')
GO

CREATE OR ALTER PROCEDURE DocGenerator.sp_MarkAsDocumented @FilePath NVARCHAR(500), @DocumentationVersion INT = NULL
AS
BEGIN
    SET NOCOUNT ON;
...
--
GO
PRINT (N'Create or alter procedure [DocGenerator].[sp_DetectFileChanges]')
GO
...
--
-- Create or alter view [DocGenerator].[vw_FilesNeedingUpdate]
--
GO
PRINT (N'Create or alter view [DocGenerator].[vw_FilesNeedingUpdate]')
GO
